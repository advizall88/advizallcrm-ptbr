...
function isEqual(a6, b2) {
  if (is.arr(a6)) {
    if (!is.arr(b2) || a6.length !== b2.length)
      return false;
...
function hslToRgb(h2, s5, l6) {
  const q = l6 < 0.5 ? l6 * (1 + s5) : l6 + s5 - l6 * s5;
  const p4 = 2 * l6 - q;
  const r5 = hue2rgb(p4, q, h2 + 1 / 3);
  const g3 = hue2rgb(p4, q, h2);
  const b2 = hue2rgb(p4, q, h2 - 1 / 3);
  return Math.round(r5 * 255) << 24 | Math.round(g3 * 255) << 16 | Math.round(b2 * 255) << 8;
}
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort3)) {
    transitions.sort((a6, b2) => sort3(a6.item, b2.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
var AnimatedStyle = class extends AnimatedObject {
  constructor({ x: x5, y: y5, z: z2, ...style }) {
    const inputs = [];
    const transforms = [];
    if (x5 || y5 || z2) {
      inputs.push([x5 || 0, y5 || 0, z2 || 0]);
      transforms.push((xyz) => [
...
function color(format3) {
  ...
  return (m3 = reHex.exec(format3)) ? (l6 = m3[1].length, m3 = parseInt(m3[1], 16), l6 === 6 ? rgbn(m3) : l6 === 3 ? new Rgb(m3 >> 8 & 15 | m3 >> 4 & 240, m3 >> 4 & 15 | m3 & 240, (m3 & 15) << 4 | m3 & 15, 1) : l6 === 8 ? rgba2(m3 >> 24 & 255, m3 >> 16 & 255, m3 >> 8 & 255, (m3 & 255) / 255) : l6 === 4 ? rgba2(m3 >> 12 & 15 | m3 >> 8 & 240, m3 >> 8 & 15 | m3 >> 4 & 240, m3 >> 4 & 15 | m3 & 240, ((m3 & 15) << 4 | m3 & 15) / 255) : null) : (m3 = reRgbInteger.exec(format3)) ? new Rgb(m3[1], m3[2], m3[3], 1) : (m3 = reRgbPercent.exec(format3)) ? new Rgb(m3[1] * 255 / 100, m3[2] * 255 / 100, m3[3] * 255 / 100, 1) : (m3 = reRgbaInteger.exec(format3)) ? rgba2(m3[1], m3[2], m3[3], m3[4]) : (m3 = reRgbaPercent.exec(format3)) ? rgba2(m3[1] * 255 / 100, m3[2] * 255 / 100, m3[3] * 255 / 100, m3[4]) : (m3 = reHslPercent.exec(format3)) ? hsla2(m3[1], m3[2] / 100, m3[3] / 100, 1) : (m3 = reHslaPercent.exec(format3)) ? hsla2(m3[1], m3[2] / 100, m3[3] / 100, m3[4]) : named.hasOwnProperty(format3) ? rgbn(named[format3]) : format3 === "transparent" ? new Rgb(NaN, NaN, NaN, 0) : null;
}
function rgbn(n5) {
  return new Rgb(n5 >> 16 & 255, n5 >> 8 & 255, n5 & 255, 1);
}
function rgba2(r5, g3, b2, a6) {
  if (a6 <= 0) r5 = g3 = b2 = NaN;
  return new Rgb(r5, g3, b2, a6);
}
...
function rgb2(r5, g3, b2, opacity) {
...
function hsla2(h2, s5, l6, a6) {
  if (a6 <= 0) h2 = s5 = l6 = NaN;
  else if (l6 <= 0 || l6 >= 1) h2 = s5 = NaN;
  else if (s5 <= 0) h2 = NaN;
  return new Hsl(h2, s5, l6, a6);
}
function hslConvert(o5) {
  ...
  o5 = o5.rgb();
  var r5 = o5.r / 255, g3 = o5.g / 255, b2 = o5.b / 255, min4 = Math.min(r5, g3, b2), max4 = Math.max(r5, g3, b2), h2 = NaN, s5 = max4 - min4, l6 = (max4 + min4) / 2;
  if (s5) {
    if (r5 === max4) h2 = (g3 - b2) / s5 + (g3 < b2) * 6;
    else if (g3 === max4) h2 = (b2 - r5) / s5 + 2;
    else h2 = (r5 - g3) / s5 + 4;
    s5 /= l6 < 0.5 ? max4 + min4 : 2 - max4 - min4;
    h2 *= 60;
  } else {
    s5 = l6 > 0 && l6 < 1 ? 0 : h2;
  }
  return new Hsl(h2, s5, l6, o5.opacity);
}
function hsl2(h2, s5, l6, opacity) {
  return arguments.length === 1 ? hslConvert(h2) : new Hsl(h2, s5, l6, opacity == null ? 1 : opacity);
}
function Hsl(h2, s5, l6, opacity) {
  this.h = +h2;
  this.s = +s5;
  this.l = +l6;
  this.opacity = +opacity;
...
define_default(Hsl, hsl2, extend(Color, {
  ...
  rgb() {
    var h2 = this.h % 360 + (this.h < 0) * 360, s5 = isNaN(h2) || isNaN(this.s) ? 0 : this.s, l6 = this.l, m22 = l6 + (l6 < 0.5 ? l6 : 1 - l6) * s5, m1 = 2 * l6 - m22;
    return new Rgb(
...
function labConvert(o5) {
  ...
  var r5 = rgb2lrgb(o5.r), g3 = rgb2lrgb(o5.g), b2 = rgb2lrgb(o5.b), y5 = xyz2lab((0.2225045 * r5 + 0.7168786 * g3 + 0.0606169 * b2) / Yn), x5, z2;
  if (r5 === g3 && g3 === b2) x5 = z2 = y5;
  else {
    x5 = xyz2lab((0.4360747 * r5 + 0.3850649 * g3 + 0.1430804 * b2) / Xn);
    z2 = xyz2lab((0.0139322 * r5 + 0.0971045 * g3 + 0.7141733 * b2) / Zn);
  }
  return new Lab(116 * y5 - 16, 500 * (x5 - y5), 200 * (y5 - z2), o5.opacity);
}
function lab(l6, a6, b2, opacity) {
  return arguments.length === 1 ? labConvert(l6) : new Lab(l6, a6, b2, opacity == null ? 1 : opacity);
}
function Lab(l6, a6, b2, opacity) {
  this.l = +l6;
  this.a = +a6;
...
function cubehelixConvert(o5) {
  ...
  if (!(o5 instanceof Rgb)) o5 = rgbConvert(o5);
  var r5 = o5.r / 255, g3 = o5.g / 255, b2 = o5.b / 255, l6 = (BC_DA * b2 + ED * r5 - EB * g3) / (BC_DA + ED - EB), bl = b2 - l6, k5 = (E * (g3 - l6) - C * bl) / D, s5 = Math.sqrt(k5 * k5 + bl * bl) / (E * l6 * (1 - l6)), h2 = s5 ? Math.atan2(k5, bl) * degrees - 120 : NaN;
  return new Cubehelix(h2 < 0 ? h2 + 360 : h2, s5, l6, o5.opacity);
}
function cubehelix(h2, s5, l6, opacity) {
  return arguments.length === 1 ? cubehelixConvert(h2) : new Cubehelix(h2, s5, l6, opacity == null ? 1 : opacity);
}
function Cubehelix(h2, s5, l6, opacity) {
  this.h = +h2;
  this.s = +s5;
...
function basis_default(values) {
  ...
  return function(t7) {
    var i5 = t7 <= 0 ? t7 = 0 : t7 >= 1 ? (t7 = 1, n5 - 1) : Math.floor(t7 * n5), v1 = values[i5], v22 = values[i5 + 1], v0 = i5 > 0 ? values[i5 - 1] : 2 * v1 - v22, v3 = i5 < n5 - 1 ? values[i5 + 2] : 2 * v22 - v1;
    return basis((t7 - i5 / n5) * n5, v0, v1, v22, v3);
  };
}
...
function basisClosed_default(values) {
  ...
  return function(t7) {
    var i5 = Math.floor(((t7 %= 1) < 0 ? ++t7 : t7) * n5), v0 = values[(i5 + n5 - 1) % n5], v1 = values[i5 % n5], v22 = values[(i5 + 1) % n5], v3 = values[(i5 + 2) % n5];
    return basis((t7 - i5 / n5) * n5, v0, v1, v22, v3);
  };
}
...
function exponential(a6, b2, y5) {
  return a6 = Math.pow(a6, y5), b2 = Math.pow(b2, y5) - a6, y5 = 1 / y5, function(t7) {
    return Math.pow(a6 + t7 * b2, y5);
  };
}
function hue(a6, b2) {
  var d4 = b2 - a6;
  return d4 ? linear(a6, d4 > 180 || d4 < -180 ? d4 - 360 * Math.round(d4 / 360) : d4) : constant_default(isNaN(a6) ? b2 : a6);
}
function gamma(y5) {
  return (y5 = +y5) === 1 ? nogamma : function(a6, b2) {
    return b2 - a6 ? exponential(a6, b2, y5) : constant_default(isNaN(a6) ? b2 : a6);
  };
}
function nogamma(a6, b2) {
  var d4 = b2 - a6;
  return d4 ? linear(a6, d4) : constant_default(isNaN(a6) ? b2 : a6);
}
...
var rgb_default = function rgbGamma(y5) {
  ...
  function rgb3(start2, end) {
    var r5 = color2((start2 = rgb2(start2)).r, (end = rgb2(end)).r), g3 = color2(start2.g, end.g), b2 = color2(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r5(t7);
      start2.g = g3(t7);
      start2.b = b2(t7);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n5 = colors3.length, r5 = new Array(n5), g3 = new Array(n5), b2 = new Array(n5), i5, color2;
    for (i5 = 0; i5 < n5; ++i5) {
...
function numberArray_default(a6, b2) {
  if (!b2) b2 = [];
  var n5 = a6 ? Math.min(b2.length, a6.length) : 0, c10 = b2.slice(), i5;
  return function(t7) {
    for (i5 = 0; i5 < n5; ++i5) c10[i5] = a6[i5] * (1 - t7) + b2[i5] * t7;
    return c10;
  };
}
...
function genericArray(a6, b2) {
  var nb = b2 ? b2.length : 0, na = a6 ? Math.min(nb, a6.length) : 0, x5 = new Array(na), c10 = new Array(nb), i5;
  for (i5 = 0; i5 < na; ++i5) x5[i5] = value_default(a6[i5], b2[i5]);
  for (; i5 < nb; ++i5) c10[i5] = b2[i5];
  return function(t7) {
    for (i5 = 0; i5 < na; ++i5) c10[i5] = x5[i5](t7);
    return c10;
  };
}

// node_modules/d3-interpolate/src/date.js
function date_default(a6, b2) {
  var d4 = /* @__PURE__ */ new Date();
  return a6 = +a6, b2 = +b2, function(t7) {
    return d4.setTime(a6 * (1 - t7) + b2 * t7), d4;
  };
}

// node_modules/d3-interpolate/src/number.js
function number_default(a6, b2) {
  return a6 = +a6, b2 = +b2, function(t7) {
    return a6 * (1 - t7) + b2 * t7;
  };
}

// node_modules/d3-interpolate/src/object.js
function object_default(a6, b2) {
  var i5 = {}, c10 = {}, k5;
  if (a6 === null || typeof a6 !== "object") a6 = {};
  if (b2 === null || typeof b2 !== "object") b2 = {};
  for (k5 in b2) {
    if (k5 in a6) {
      i5[k5] = value_default(a6[k5], b2[k5]);
    } else {
      c10[k5] = b2[k5];
    }
  }
...
function string_default(a6, b2) {
  var bi = reA.lastIndex = reB.lastIndex = 0, am, bm, bs, i5 = -1, s5 = [], q = [];
  a6 = a6 + "", b2 = b2 + "";
  while ((am = reA.exec(a6)) && (bm = reB.exec(b2))) {
    if ((bs = bm.index) > bi) {
      bs = b2.slice(bi, bs);
      if (s5[i5]) s5[i5] += bs;
      else s5[++i5] = bs;
  ...
  return s5.length < 2 ? q[0] ? one(q[0].x) : zero(b2) : (b2 = q.length, function(t7) {
    for (var i6 = 0, o5; i6 < b2; ++i6) s5[(o5 = q[i6]).i] = o5.x(t7);
    return s5.join("");
  });
}

// node_modules/d3-interpolate/src/value.js
function value_default(a6, b2) {
  var t7 = typeof b2, c10;
  return b2 == null || t7 === "boolean" ? constant_default(b2) : (t7 === "number" ? number_default : t7 === "string" ? (c10 = color(b2)) ? (b2 = c10, rgb_default) : string_default : b2 instanceof color ? rgb_default : b2 instanceof Date ? date_default : isNumberArray(b2) ? numberArray_default : Array.isArray(b2) ? genericArray : typeof b2.valueOf !== "function" && typeof b2.toString !== "function" || isNaN(b2) ? object_default : number_default)(a6, b2);
}

// node_modules/d3-interpolate/src/round.js
function round_default(a6, b2) {
  return a6 = +a6, b2 = +b2, function(t7) {
    return Math.round(a6 * (1 - t7) + b2 * t7);
  };
}
...
function decompose_default(a6, b2, c10, d4, e8, f4) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a6 * a6 + b2 * b2)) a6 /= scaleX, b2 /= scaleX;
  if (skewX = a6 * c10 + b2 * d4) c10 -= a6 * skewX, d4 -= b2 * skewX;
  if (scaleY = Math.sqrt(c10 * c10 + d4 * d4)) c10 /= scaleY, d4 /= scaleY, skewX /= scaleY;
  if (a6 * d4 < b2 * c10) a6 = -a6, b2 = -b2, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e8,
    translateY: f4,
    rotate: Math.atan2(b2, a6) * degrees2,
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s5, q) {
    if (xa !== xb || ya !== yb) {
      var i5 = s5.push("translate(", null, pxComma, null, pxParen);
      q.push({ i: i5 - 4, x: number_default(xa, xb) }, { i: i5 - 2, x: number_default(ya, yb) });
    } else if (xb || yb) {
      s5.push("translate(" + xb + pxComma + yb + pxParen);
    }
  }
  function rotate(a6, b2, s5, q) {
    if (a6 !== b2) {
      if (a6 - b2 > 180) b2 += 360;
      else if (b2 - a6 > 180) a6 += 360;
      q.push({ i: s5.push(pop(s5) + "rotate(", null, degParen) - 2, x: number_default(a6, b2) });
    } else if (b2) {
      s5.push(pop(s5) + "rotate(" + b2 + degParen);
    }
  }
  function skewX(a6, b2, s5, q) {
    if (a6 !== b2) {
      q.push({ i: s5.push(pop(s5) + "skewX(", null, degParen) - 2, x: number_default(a6, b2) });
    } else if (b2) {
      s5.push(pop(s5) + "skewX(" + b2 + degParen);
    }
  }
  function scale(xa, ya, xb, yb, s5, q) {
    if (xa !== xb || ya !== yb) {
      var i5 = s5.push(pop(s5) + "scale(", null, ",", null, ")");
      q.push({ i: i5 - 4, x: number_default(xa, xb) }, { i: i5 - 2, x: number_default(ya, yb) });
    } else if (xb !== 1 || yb !== 1) {
      s5.push(pop(s5) + "scale(" + xb + "," + yb + ")");
    }
  }
  return function(a6, b2) {
    var s5 = [], q = [];
    a6 = parse(a6), b2 = parse(b2);
    translate(a6.translateX, a6.translateY, b2.translateX, b2.translateY, s5, q);
    rotate(a6.rotate, b2.rotate, s5, q);
    skewX(a6.skewX, b2.skewX, s5, q);
    scale(a6.scaleX, a6.scaleY, b2.scaleX, b2.scaleY, s5, q);
    a6 = b2 = null;
    return function(t7) {
      var i5 = -1, n5 = q.length, o5;
      while (++i5 < n5) s5[(o5 = q[i5]).i] = o5.x(t7);
      return s5.join("");
    };
  };
}
...
var zoom_default = function zoomRho(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon2) {
      ...
      S2 = (r1 - r0) / rho;
      i5 = function(t7) {
        var s5 = t7 * S2, coshr0 = cosh(r0), u5 = w0 / (rho2 * d1) * (coshr0 * tanh(rho * s5 + r0) - sinh(r0));
        return [
          ux0 + u5 * dx,
          uy0 + u5 * dy,
    ...
    i5.duration = S2 * 1e3 * rho / Math.SQRT2;
    return i5;
  }
  zoom.rho = function(_) {
...
function hsl3(hue2) {
  return function(start2, end) {
    var h2 = hue2((start2 = hsl2(start2)).h, (end = hsl2(end)).h), s5 = nogamma(start2.s, end.s), l6 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h2(t7);
      start2.s = s5(t7);
      start2.l = l6(t7);
...
function cubehelix2(hue2) {
  return function cubehelixGamma(y5) {
    ...
    function cubehelix3(start2, end) {
      var h2 = hue2((start2 = cubehelix(start2)).h, (end = cubehelix(end)).h), s5 = nogamma(start2.s, end.s), l6 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
      return function(t7) {
        start2.h = h2(t7);
        start2.s = s5(t7);
...
function append(strings) {
  this._ += strings[0];
  for (let i5 = 1, n5 = strings.length; i5 < n5; ++i5) {
...
var Path = class {
  ...
  rect(x5, y5, w2, h2) {
    this._append`M${this._x0 = this._x1 = +x5},${this._y0 = this._y1 = +y5}h${w2 = +w2}v${+h2}h${-w2}Z`;
  }
  toString() {
    return this._;
  }
...
function withPath(shape) {
  ...
  shape.digits = function(_) {
    ...
    if (_ == null) {
      ...
      const d4 = Math.floor(_);
      if (!(d4 >= 0)) throw new RangeError(`invalid digits: ${_}`);
      digits = d4;
    }
    return shape;
  };
...
function line_default(x5, y5) {
  ...
  y5 = typeof y5 === "function" ? y5 : y5 === void 0 ? y : constant_default2(y5);
  function line(data) {
    var i5, n5 = (data = array_default2(data)).length, d4, defined0 = false, buffer;
    if (context == null) output = curve(buffer = path2());
    for (i5 = 0; i5 <= n5; ++i5) {
      if (!(i5 < n5 && defined(d4 = data[i5], i5, data)) === defined0) {
        if (defined0 = !defined0) output.lineStart();
        else output.lineEnd();
      }
      if (defined0) output.point(+x5(d4, i5, data), +y5(d4, i5, data));
    }
...
function area_default(x0, y0, y1) {
  ...
  function area(data) {
    var i5, j3, k5, n5 = (data = array_default2(data)).length, d4, defined0 = false, buffer, x0z = new Array(n5), y0z = new Array(n5);
    if (context == null) output = curve(buffer = path2());
    for (i5 = 0; i5 <= n5; ++i5) {
      if (!(i5 < n5 && defined(d4 = data[i5], i5, data)) === defined0) {
...
function descending_default(a6, b2) {
  return b2 < a6 ? -1 : b2 > a6 ? 1 : b2 >= a6 ? 0 : NaN;
}
...
function pie_default() {
  ...
  function pie(data) {
    var i5, n5 = (data = array_default2(data)).length, j3, k5, sum4 = 0, index3 = new Array(n5), arcs = new Array(n5), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p4 = Math.min(Math.abs(da) / n5, padAngle.apply(this, arguments)), pa = p4 * (da < 0 ? -1 : 1), v3;
    for (i5 = 0; i5 < n5; ++i5) {
      if ((v3 = arcs[index3[i5] = i5] = +value(data[i5], i5, data)) > 0) {
        sum4 += v3;
      }
    }
    if (sortValues != null) index3.sort(function(i6, j4) {
      return sortValues(arcs[i6], arcs[j4]);
    });
    else if (sort3 != null) index3.sort(function(i6, j4) {
      return sort3(data[i6], data[j4]);
    });
    for (i5 = 0, k5 = sum4 ? (da - n5 * pa) / sum4 : 0; i5 < n5; ++i5, a0 = a1) {
      j3 = index3[i5], v3 = arcs[j3], a1 = a0 + (v3 > 0 ? v3 * k5 : 0) + pa, arcs[j3] = {
        data: data[j3],
        index: i5,
        value: v3,
        startAngle: a0,
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    var x5 = this._x, y5 = this._y, j3 = x5.length - 1;
    if (j3 > 0) {
      var x0 = x5[0], y0 = y5[0], dx = x5[j3] - x0, dy = y5[j3] - y0, i5 = -1, t7;
      while (++i5 <= j3) {
        t7 = i5 / j3;
        this._basis.point(
          this._beta * x5[i5] + (1 - this._beta) * (x0 + t7 * dx),
...
function point3(that, x5, y5) {
  ...
  if (that._l01_a > epsilon) {
    var a6 = 2 * that._l01_2a + 3 * that._l01_a * that._l12_a + that._l12_2a, n5 = 3 * that._l01_a * (that._l01_a + that._l12_a);
    x1 = (x1 * a6 - that._x0 * that._l12_2a + that._x2 * that._l01_2a) / n5;
    y1 = (y1 * a6 - that._y0 * that._l12_2a + that._y2 * that._l01_2a) / n5;
  }
...
function controlPoints(x5) {
  var i5, n5 = x5.length - 1, m3, a6 = new Array(n5), b2 = new Array(n5), r5 = new Array(n5);
  a6[0] = 0, b2[0] = 2, r5[0] = x5[0] + 2 * x5[1];
  for (i5 = 1; i5 < n5 - 1; ++i5) a6[i5] = 1, b2[i5] = 4, r5[i5] = 4 * x5[i5] + 2 * x5[i5 + 1];
  a6[n5 - 1] = 2, b2[n5 - 1] = 7, r5[n5 - 1] = 8 * x5[n5 - 1] + x5[n5];
  for (i5 = 1; i5 < n5; ++i5) m3 = a6[i5] / b2[i5 - 1], b2[i5] -= m3, r5[i5] -= m3 * r5[i5 - 1];
  a6[n5 - 1] = r5[n5 - 1] / b2[n5 - 1];
  for (i5 = n5 - 2; i5 >= 0; --i5) a6[i5] = (r5[i5] - a6[i5 + 1]) / b2[i5];
  b2[n5 - 1] = (x5[n5] + a6[n5 - 1]) / 2;
  for (i5 = 0; i5 < n5 - 1; ++i5) b2[i5] = 2 * x5[i5 + 1] - a6[i5 + 1];
  return [a6, b2];
}
...
function none_default(series, order) {
  ...
  for (var i5 = 1, j3, s0, s1 = series[order[0]], n5, m3 = s1.length; i5 < n5; ++i5) {
...
function none_default2(series) {
  var n5 = series.length, o5 = new Array(n5);
  while (--n5 >= 0) o5[n5] = n5;
  return o5;
}
...
function stack_default() {
  ...
  function stack(data) {
    var sz = Array.from(keys.apply(this, arguments), stackSeries), i5, n5 = sz.length, j3 = -1, oz;
    for (const d4 of data) {
      for (i5 = 0, ++j3; i5 < n5; ++i5) {
        (sz[i5][j3] = [0, +value(d4, sz[i5].key, j3, data)]).data = d4;
      }
    }
    for (i5 = 0, oz = array_default2(order(sz)); i5 < n5; ++i5) {
      sz[oz[i5]].index = i5;
    }
    offset(sz, oz);
    return sz;
...
function expand_default(series, order) {
  ...
  for (var i5, n5, j3 = 0, m3 = series[0].length, y5; j3 < m3; ++j3) {
    for (y5 = i5 = 0; i5 < n5; ++i5) y5 += series[i5][j3][1] || 0;
    if (y5) for (i5 = 0; i5 < n5; ++i5) series[i5][j3][1] /= y5;
  }
...
function diverging_default(series, order) {
  if (!((n5 = series.length) > 0)) return;
  for (var i5, j3 = 0, d4, dy, yp, yn2, n5, m3 = series[order[0]].length; j3 < m3; ++j3) {
    for (yp = yn2 = 0, i5 = 0; i5 < n5; ++i5) {
      if ((dy = (d4 = series[order[i5]][j3])[1] - d4[0]) > 0) {
        d4[0] = yp, d4[1] = yp += dy;
      } else if (dy < 0) {
...
function silhouette_default(series, order) {
  if (!((n5 = series.length) > 0)) return;
  for (var j3 = 0, s0 = series[order[0]], n5, m3 = s0.length; j3 < m3; ++j3) {
    for (var i5 = 0, y5 = 0; i5 < n5; ++i5) y5 += series[i5][j3][1] || 0;
...
function wiggle_default(series, order) {
  if (!((n5 = series.length) > 0) || !((m3 = (s0 = series[order[0]]).length) > 0)) return;
  for (var y5 = 0, j3 = 1, s0, m3, n5; j3 < m3; ++j3) {
    for (var i5 = 0, s1 = 0, s22 = 0; i5 < n5; ++i5) {
...
function appearance_default(series) {
  ...
  return none_default2(series).sort(function(a6, b2) {
    return peaks[a6] - peaks[b2];
  });
}
function peak(series) {
  var i5 = -1, j3 = 0, n5 = series.length, vi, vj = -Infinity;
  while (++i5 < n5) if ((vi = +series[i5][1]) > vj) vj = vi, j3 = i5;
  return j3;
}
...
function ascending_default(series) {
  ...
  return none_default2(series).sort(function(a6, b2) {
    return sums[a6] - sums[b2];
  });
}
function sum(series) {
  var s5 = 0, i5 = -1, n5 = series.length, v3;
  while (++i5 < n5) if (v3 = +series[i5][1]) s5 += v3;
  return s5;
}
...
function insideOut_default(series) {
  var n5 = series.length, i5, j3, sums = series.map(sum), order = appearance_default(series), top = 0, bottom = 0, tops = [], bottoms = [];
  for (i5 = 0; i5 < n5; ++i5) {
    j3 = order[i5];
    if (top < bottom) {
      top += sums[j3];
...
function ascending(a6, b2) {
  return a6 == null || b2 == null ? NaN : a6 < b2 ? -1 : a6 > b2 ? 1 : a6 >= b2 ? 0 : NaN;
}

// node_modules/d3-array/src/descending.js
function descending(a6, b2) {
  return a6 == null || b2 == null ? NaN : b2 < a6 ? -1 : b2 > a6 ? 1 : b2 >= a6 ? 0 : NaN;
}
...
function bisector(f4) {
  ...
  function left(a6, x5, lo = 0, hi = a6.length) {
    if (lo < hi) {
      if (compare1(x5, x5) !== 0) return hi;
      do {
        const mid = lo + hi >>> 1;
        if (compare2(a6[mid], x5) < 0) lo = mid + 1;
        else hi = mid;
      } while (lo < hi);
    }
    return lo;
  }
  function right(a6, x5, lo = 0, hi = a6.length) {
    if (lo < hi) {
      if (compare1(x5, x5) !== 0) return hi;
      do {
        const mid = lo + hi >>> 1;
  ...
  function center(a6, x5, lo = 0, hi = a6.length) {
    const i5 = left(a6, x5, lo, hi - 1);
    return i5 > lo && delta(a6[i5 - 1], x5) > -delta(a6[i5], x5) ? i5 - 1 : i5;
  }
...
function blurh(blur3, T2, S2, w2, h2) {
  for (let y5 = 0, n5 = w2 * h2; y5 < n5; ) {
    blur3(T2, S2, y5, y5 += w2, 1);
  }
}
function blurv(blur3, T2, S2, w2, h2) {
  for (let x5 = 0, n5 = w2 * h2; x5 < w2; ++x5) {
    blur3(T2, S2, x5, x5 + n5, w2);
  }
}
...
function blurf(radius) {
  ...
  return (T2, S2, start2, stop2, step) => {
    ...
    for (let i5 = start2, j3 = start2 + s0; i5 < j3; i5 += step) {
      sum4 += S2[Math.min(stop2, i5)];
    }
    for (let i5 = start2, j3 = stop2; i5 <= j3; i5 += step) {
      sum4 += S2[Math.min(stop2, i5 + s0)];
      T2[i5] = (sum4 + t7 * (S2[Math.max(start2, i5 - s1)] + S2[Math.min(stop2, i5 + s1)])) / w2;
      sum4 -= S2[Math.max(start2, i5 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T2, S2, start2, stop2, step) => {
    ...
    for (let i5 = start2, j3 = start2 + s5; i5 < j3; i5 += step) {
      sum4 += S2[Math.min(stop2, i5)];
    }
    for (let i5 = start2, j3 = stop2; i5 <= j3; i5 += step) {
      sum4 += S2[Math.min(stop2, i5 + s5)];
      T2[i5] = sum4 / w2;
      sum4 -= S2[Math.max(start2, i5 - s5)];
    }
  };
}
...
function ticks(start2, stop2, count3) {
  ...
  if (reverse3) {
    if (inc < 0) for (let i5 = 0; i5 < n5; ++i5) ticks2[i5] = (i22 - i5) / -inc;
    else for (let i5 = 0; i5 < n5; ++i5) ticks2[i5] = (i22 - i5) * inc;
  } else {
    if (inc < 0) for (let i5 = 0; i5 < n5; ++i5) ticks2[i5] = (i1 + i5) / -inc;
    else for (let i5 = 0; i5 < n5; ++i5) ticks2[i5] = (i1 + i5) * inc;
  }
  return ticks2;
}
...
function range(start2, stop2, step) {
  ...
  var i5 = -1, n5 = Math.max(0, Math.ceil((stop2 - start2) / step)) | 0, range2 = new Array(n5);
  while (++i5 < n5) {
...
function ordinal() {
  ...
  function scale(d4) {
    let i5 = index3.get(d4);
    if (i5 === void 0) {
      if (unknown !== implicit) return unknown;
      index3.set(d4, i5 = domain.push(d4) - 1);
    }
...
function band() {
  ...
  function rescale() {
    var n5 = domain().length, reverse3 = r1 < r0, start2 = reverse3 ? r1 : r0, stop2 = reverse3 ? r0 : r1;
    ...
    var values = range(n5).map(function(i5) {
...
function normalize(a6, b2) {
  return (b2 -= a6 = +a6) ? function(x5) {
    return (x5 - a6) / b2;
  } : constants(isNaN(b2) ? NaN : 0.5);
}
function clamper(a6, b2) {
  var t7;
  if (a6 > b2) t7 = a6, a6 = b2, b2 = t7;
  return function(x5) {
    return Math.max(a6, Math.min(b2, x5));
  };
}
...
function polymap(domain, range2, interpolate2) {
  var j3 = Math.min(domain.length, range2.length) - 1, d4 = new Array(j3), r5 = new Array(j3), i5 = -1;
  ...
  return function(x5) {
    var i6 = bisect_default(domain, x5, 1, j3) - 1;
    return r5[i6](d4[i6](x5));
  };
}
...
function formatDecimalParts(x5, p4) {
  if ((i5 = (x5 = p4 ? x5.toExponential(p4 - 1) : x5.toExponential()).indexOf("e")) < 0) return null;
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i5 = value.length, t7 = [], j3 = 0, g3 = grouping[0], length = 0;
    while (i5 > 0 && g3 > 0) {
...
function formatTrim_default(s5) {
  out: for (var n5 = s5.length, i5 = 1, i0 = -1, i1; i5 < n5; ++i5) {
    switch (s5[i5]) {
      case ".":
        i0 = i1 = i5;
        break;
...
function formatPrefixAuto_default(x5, p4) {
  var d4 = formatDecimalParts(x5, p4);
  if (!d4) return x5 + "";
  var coefficient = d4[0], exponent = d4[1], i5 = exponent - (prefixExponent = Math.max(-8, Math.min(8, Math.floor(exponent / 3))) * 3) + 1, n5 = coefficient.length;
  return i5 === n5 ? coefficient : i5 > n5 ? coefficient + new Array(i5 - n5 + 1).join("0") : i5 > 0 ? coefficient.slice(0, i5) + "." + coefficient.slice(i5) : "0." + new Array(1 - i5).join("0") + formatDecimalParts(x5, Math.max(0, p4 + i5 - 1))[0];
}
...
function locale_default(locale5) {
  ...
  function newFormat(specifier) {
    ...
    function format3(value) {
      var valuePrefix = prefix2, valueSuffix = suffix, i5, n5, c10;
      if (type === "c") {
...
function linearish(scale) {
  ...
  scale.ticks = function(count3) {
    var d4 = domain();
    return ticks(d4[0], d4[d4.length - 1], count3 == null ? 10 : count3);
  };
...
function loggish(transform) {
  ...
  scale.ticks = (count3) => {
    ...
    let k5;
    let t7;
    const n5 = count3 == null ? 10 : +count3;
    let z2 = [];
    if (!(base % 1) && j3 - i5 < n5) {
      i5 = Math.floor(i5), j3 = Math.ceil(j3);
      if (u5 > 0) for (; i5 <= j3; ++i5) {
        for (k5 = 1; k5 < base; ++k5) {
      ...
      if (z2.length * 2 < n5) z2 = ticks(u5, v3, n5);
    } else {
      z2 = ticks(i5, j3, Math.min(j3 - i5, n5)).map(pows);
    }
    return r5 ? z2.reverse() : z2;
  };
  scale.tickFormat = (count3, specifier) => {
    ...
    const k5 = Math.max(1, base * count3 / scale.ticks().length);
    return (d4) => {
...
function transformSymlog(c10) {
  return function(x5) {
    return Math.sign(x5) * Math.log1p(Math.abs(x5 / c10));
  };
}
function transformSymexp(c10) {
  return function(x5) {
    return Math.sign(x5) * Math.expm1(Math.abs(x5)) * c10;
  };
}
...
function formatLocale(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i5 = -1, j3 = 0, n5 = specifier.length, c10, pad3, format3;
      if (!(date2 instanceof Date)) date2 = /* @__PURE__ */ new Date(+date2);
      while (++i5 < n5) {
        if (specifier.charCodeAt(i5) === 37) {
          string.push(specifier.slice(j3, i5));
          if ((pad3 = pads[c10 = specifier.charAt(++i5)]) != null) c10 = specifier.charAt(++i5);
          else pad3 = c10 === "e" ? " " : "0";
          if (format3 = formats2[c10]) c10 = format3(date2, pad3);
          string.push(c10);
          j3 = i5 + 1;
        }
      }
    ...
    return function(string) {
      ...
      if ("V" in d4) {
        ...
        if ("Z" in d4) {
          ...
          week = utcDay.offset(week, (d4.V - 1) * 7);
          ...
          week = timeDay.offset(week, (d4.V - 1) * 7);
  ...
  function parseSpecifier(d4, specifier, string, j3) {
    var i5 = 0, n5 = specifier.length, m3 = string.length, c10, parse;
    while (i5 < n5) {
      if (j3 >= m3) return -1;
      ...
      } else if (c10 != string.charCodeAt(j3++)) {
        return -1;
      }
    }
    return j3;
  ...
  function parsePeriod(d4, string, i5) {
    ...
    return n5 ? (d4.p = periodLookup.get(n5[0].toLowerCase()), i5 + n5[0].length) : -1;
  }
  function parseShortWeekday(d4, string, i5) {
    var n5 = shortWeekdayRe.exec(string.slice(i5));
    return n5 ? (d4.w = shortWeekdayLookup.get(n5[0].toLowerCase()), i5 + n5[0].length) : -1;
  }
  function parseWeekday(d4, string, i5) {
    var n5 = weekdayRe.exec(string.slice(i5));
    return n5 ? (d4.w = weekdayLookup.get(n5[0].toLowerCase()), i5 + n5[0].length) : -1;
  }
  function parseShortMonth(d4, string, i5) {
    var n5 = shortMonthRe.exec(string.slice(i5));
    return n5 ? (d4.m = shortMonthLookup.get(n5[0].toLowerCase()), i5 + n5[0].length) : -1;
  }
  function parseMonth(d4, string, i5) {
    var n5 = monthRe.exec(string.slice(i5));
    return n5 ? (d4.m = monthLookup.get(n5[0].toLowerCase()), i5 + n5[0].length) : -1;
  }
...
function parseWeekdayNumberSunday(d4, string, i5) {
  ...
  return n5 ? (d4.w = +n5[0], i5 + n5[0].length) : -1;
}
function parseWeekdayNumberMonday(d4, string, i5) {
  var n5 = numberRe.exec(string.slice(i5, i5 + 1));
  return n5 ? (d4.u = +n5[0], i5 + n5[0].length) : -1;
}
...
function parseWeekNumberISO(d4, string, i5) {
  var n5 = numberRe.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.V = +n5[0], i5 + n5[0].length) : -1;
}
...
function parseUnixTimestamp(d4, string, i5) {
  ...
  return n5 ? (d4.Q = +n5[0], i5 + n5[0].length) : -1;
}
...
function formatDayOfYear(d4, p4) {
  return pad(1 + timeDay.count(timeYear(d4), d4), p4, 3);
}
...
function formatWeekNumberSunday(d4, p4) {
  return pad(timeSunday.count(timeYear(d4) - 1, d4), p4, 2);
}
function dISO(d4) {
  var day2 = d4.getDay();
  return day2 >= 4 || day2 === 0 ? timeThursday(d4) : timeThursday.ceil(d4);
}
function formatWeekNumberISO(d4, p4) {
  d4 = dISO(d4);
  return pad(timeThursday.count(timeYear(d4), d4) + (timeYear(d4).getDay() === 4), p4, 2);
}
function formatWeekdayNumberSunday(d4) {
  return d4.getDay();
}
function formatWeekNumberMonday(d4, p4) {
  return pad(timeMonday.count(timeYear(d4) - 1, d4), p4, 2);
}
...
function formatFullYearISO(d4, p4) {
  var day2 = d4.getDay();
  d4 = day2 >= 4 || day2 === 0 ? timeThursday(d4) : timeThursday.ceil(d4);
  return pad(d4.getFullYear() % 1e4, p4, 4);
}
...
function formatUTCDayOfYear(d4, p4) {
  return pad(1 + utcDay.count(utcYear(d4), d4), p4, 3);
}
...
function formatUTCWeekNumberSunday(d4, p4) {
  return pad(utcSunday.count(utcYear(d4) - 1, d4), p4, 2);
}
function UTCdISO(d4) {
...
function formatUTCWeekNumberISO(d4, p4) {
  d4 = UTCdISO(d4);
  return pad(utcThursday.count(utcYear(d4), d4) + (utcYear(d4).getUTCDay() === 4), p4, 2);
}
function formatUTCWeekdayNumberSunday(d4) {
  return d4.getUTCDay();
}
function formatUTCWeekNumberMonday(d4, p4) {
  return pad(utcMonday.count(utcYear(d4) - 1, d4), p4, 2);
}
...
function colors_default(specifier) {
  var n5 = specifier.length / 6 | 0, colors3 = new Array(n5), i5 = 0;
  while (i5 < n5) colors3[i5] = "#" + specifier.slice(i5 * 6, ++i5 * 6);
  return colors3;
}
...
function sinebow_default(t7) {
  var x5;
  t7 = (0.5 - t7) * Math.PI;
  c7.r = 255 * (x5 = Math.sin(t7)) * x5;
  c7.g = 255 * (x5 = Math.sin(t7 + pi_1_3)) * x5;
  c7.b = 255 * (x5 = Math.sin(t7 + pi_2_3)) * x5;
  return c7 + "";
}
...
function ramp(range2) {
  ...
  return function(t7) {
    return range2[Math.max(0, Math.min(n5 - 1, Math.floor(t7 * n5)))];
  };
}
...
function formatPrefixAuto_default2(x5, p4) {
  var d4 = formatDecimalParts2(x5, p4);
  if (!d4) return x5 + "";
  var coefficient = d4[0], exponent = d4[1], i5 = exponent - (prefixExponent2 = Math.max(-8, Math.min(8, Math.floor(exponent / 3))) * 3) + 1, n5 = coefficient.length;
  return i5 === n5 ? coefficient : i5 > n5 ? coefficient + new Array(i5 - n5 + 1).join("0") : i5 > 0 ? coefficient.slice(0, i5) + "." + coefficient.slice(i5) : "0." + new Array(1 - i5).join("0") + formatDecimalParts2(x5, Math.max(0, p4 + i5 - 1))[0];
}
...
function locale_default2(locale5) {
  ...
  function formatPrefix3(specifier, value) {
    var f4 = newFormat((specifier = formatSpecifier2(specifier), specifier.type = "f", specifier)), e8 = Math.max(-8, Math.min(8, Math.floor(exponent_default2(value) / 3))) * 3, k5 = Math.pow(10, -e8), prefix2 = prefixes3[8 + e8 / 3];
    return function(value2) {
      return f4(k5 * value2) + prefix2;
    };
  }
...
function ascending_default2(a6, b2) {
  return a6 < b2 ? -1 : a6 > b2 ? 1 : a6 >= b2 ? 0 : NaN;
}
...
function bisector_default(f4) {
  ...
  function left(a6, x5, lo, hi) {
    if (lo == null) lo = 0;
    if (hi == null) hi = a6.length;
    while (lo < hi) {
      const mid = lo + hi >>> 1;
      if (compare(a6[mid], x5) < 0) lo = mid + 1;
      else hi = mid;
    }
    return lo;
  }
  function right(a6, x5, lo, hi) {
    if (lo == null) lo = 0;
    if (hi == null) hi = a6.length;
    while (lo < hi) {
      const mid = lo + hi >>> 1;
      if (compare(a6[mid], x5) > 0) hi = mid;
      else lo = mid + 1;
    }
    return lo;
  }
  function center(a6, x5, lo, hi) {
    if (lo == null) lo = 0;
    if (hi == null) hi = a6.length;
    const i5 = left(a6, x5, lo, hi - 1);
    return i5 > lo && delta(a6[i5 - 1], x5) > -delta(a6[i5], x5) ? i5 - 1 : i5;
...
function ascendingComparator(f4) {
  return (d4, x5) => ascending_default2(f4(d4), x5);
}
...
function formatLocale2(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      ...
      while (++i5 < n5) {
        if (specifier.charCodeAt(i5) === 37) {
          string.push(specifier.slice(j3, i5));
          if ((pad3 = pads2[c10 = specifier.charAt(++i5)]) != null) c10 = specifier.charAt(++i5);
          else pad3 = c10 === "e" ? " " : "0";
          if (format3 = formats2[c10]) c10 = format3(date2, pad3);
          string.push(c10);
          j3 = i5 + 1;
  ...
  function newParse(specifier, Z) {
    return function(string) {
      var d4 = newDate2(1900, void 0, 1), i5 = parseSpecifier(d4, specifier, string += "", 0), week, day2;
      if (i5 != string.length) return null;
      if ("Q" in d4) return new Date(d4.Q);
      if ("s" in d4) return new Date(d4.s * 1e3 + ("L" in d4 ? d4.L : 0));
      if (Z && !("Z" in d4)) d4.Z = 0;
      ...
      if ("V" in d4) {
        ...
        if (!("w" in d4)) d4.w = 1;
        if ("Z" in d4) {
          week = utcDate2(newDate2(d4.y, 0, 1)), day2 = week.getUTCDay();
          ...
          week = localDate2(newDate2(d4.y, 0, 1)), day2 = week.getDay();
        ...
        if (!("w" in d4)) d4.w = "u" in d4 ? d4.u % 7 : "W" in d4 ? 1 : 0;
        day2 = "Z" in d4 ? utcDate2(newDate2(d4.y, 0, 1)).getUTCDay() : localDate2(newDate2(d4.y, 0, 1)).getDay();
        d4.m = 0;
        d4.d = "W" in d4 ? (d4.w + 6) % 7 + d4.W * 7 - (day2 + 5) % 7 : d4.w + d4.U * 7 - (day2 + 6) % 7;
      }
      if ("Z" in d4) {
  ...
  function parseSpecifier(d4, specifier, string, j3) {
    ...
    while (i5 < n5) {
      ...
      if (c10 === 37) {
        c10 = specifier.charAt(i5++);
        parse = parses[c10 in pads2 ? specifier.charAt(i5++) : c10];
        if (!parse || (j3 = parse(d4, string, j3)) < 0) return -1;
      } else if (c10 != string.charCodeAt(j3++)) {
        return -1;
      }
...
function parseWeekdayNumberSunday2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 1));
  return n5 ? (d4.w = +n5[0], i5 + n5[0].length) : -1;
}
function parseWeekdayNumberMonday2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 1));
  return n5 ? (d4.u = +n5[0], i5 + n5[0].length) : -1;
}
function parseWeekNumberSunday2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.U = +n5[0], i5 + n5[0].length) : -1;
}
function parseWeekNumberISO2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.V = +n5[0], i5 + n5[0].length) : -1;
}
function parseWeekNumberMonday2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.W = +n5[0], i5 + n5[0].length) : -1;
}
function parseFullYear2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 4));
  return n5 ? (d4.y = +n5[0], i5 + n5[0].length) : -1;
}
function parseYear2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.y = +n5[0] + (+n5[0] > 68 ? 1900 : 2e3), i5 + n5[0].length) : -1;
}
function parseZone2(d4, string, i5) {
  var n5 = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(string.slice(i5, i5 + 6));
  return n5 ? (d4.Z = n5[1] ? 0 : -(n5[2] + (n5[3] || "00")), i5 + n5[0].length) : -1;
}
function parseQuarter2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 1));
  return n5 ? (d4.q = n5[0] * 3 - 3, i5 + n5[0].length) : -1;
}
function parseMonthNumber2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.m = n5[0] - 1, i5 + n5[0].length) : -1;
}
function parseDayOfMonth2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.d = +n5[0], i5 + n5[0].length) : -1;
}
function parseDayOfYear2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 3));
  return n5 ? (d4.m = 0, d4.d = +n5[0], i5 + n5[0].length) : -1;
}
function parseHour242(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.H = +n5[0], i5 + n5[0].length) : -1;
}
function parseMinutes2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.M = +n5[0], i5 + n5[0].length) : -1;
}
function parseSeconds2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 2));
  return n5 ? (d4.S = +n5[0], i5 + n5[0].length) : -1;
}
function parseMilliseconds2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 3));
  return n5 ? (d4.L = +n5[0], i5 + n5[0].length) : -1;
}
function parseMicroseconds2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5, i5 + 6));
  return n5 ? (d4.L = Math.floor(n5[0] / 1e3), i5 + n5[0].length) : -1;
}
function parseLiteralPercent2(d4, string, i5) {
  var n5 = percentRe2.exec(string.slice(i5, i5 + 1));
  return n5 ? i5 + n5[0].length : -1;
}
function parseUnixTimestamp2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5));
  return n5 ? (d4.Q = +n5[0], i5 + n5[0].length) : -1;
}
function parseUnixTimestampSeconds2(d4, string, i5) {
  var n5 = numberRe2.exec(string.slice(i5));
  return n5 ? (d4.s = +n5[0], i5 + n5[0].length) : -1;
}
function formatDayOfMonth2(d4, p4) {
  return pad2(d4.getDate(), p4, 2);
}
function formatHour242(d4, p4) {
  return pad2(d4.getHours(), p4, 2);
}
function formatHour122(d4, p4) {
  return pad2(d4.getHours() % 12 || 12, p4, 2);
}
function formatDayOfYear2(d4, p4) {
  return pad2(1 + day_default.count(year_default(d4), d4), p4, 3);
}
function formatMilliseconds2(d4, p4) {
  return pad2(d4.getMilliseconds(), p4, 3);
}
function formatMicroseconds2(d4, p4) {
  return formatMilliseconds2(d4, p4) + "000";
}
function formatMonthNumber2(d4, p4) {
  return pad2(d4.getMonth() + 1, p4, 2);
}
function formatMinutes2(d4, p4) {
  return pad2(d4.getMinutes(), p4, 2);
}
function formatSeconds2(d4, p4) {
  return pad2(d4.getSeconds(), p4, 2);
}
function formatWeekdayNumberMonday2(d4) {
  var day2 = d4.getDay();
  return day2 === 0 ? 7 : day2;
}
function formatWeekNumberSunday2(d4, p4) {
  return pad2(sunday.count(year_default(d4) - 1, d4), p4, 2);
}
function dISO2(d4) {
  var day2 = d4.getDay();
  return day2 >= 4 || day2 === 0 ? thursday(d4) : thursday.ceil(d4);
}
function formatWeekNumberISO2(d4, p4) {
  d4 = dISO2(d4);
  return pad2(thursday.count(year_default(d4), d4) + (year_default(d4).getDay() === 4), p4, 2);
}
function formatWeekdayNumberSunday2(d4) {
  return d4.getDay();
}
function formatWeekNumberMonday2(d4, p4) {
  return pad2(monday.count(year_default(d4) - 1, d4), p4, 2);
}
function formatYear2(d4, p4) {
  return pad2(d4.getFullYear() % 100, p4, 2);
}
function formatYearISO2(d4, p4) {
  d4 = dISO2(d4);
  return pad2(d4.getFullYear() % 100, p4, 2);
}
function formatFullYear2(d4, p4) {
  return pad2(d4.getFullYear() % 1e4, p4, 4);
}
function formatFullYearISO2(d4, p4) {
  var day2 = d4.getDay();
  d4 = day2 >= 4 || day2 === 0 ? thursday(d4) : thursday.ceil(d4);
  return pad2(d4.getFullYear() % 1e4, p4, 4);
}
function formatZone2(d4) {
  var z2 = d4.getTimezoneOffset();
  return (z2 > 0 ? "-" : (z2 *= -1, "+")) + pad2(z2 / 60 | 0, "0", 2) + pad2(z2 % 60, "0", 2);
}
function formatUTCDayOfMonth2(d4, p4) {
  return pad2(d4.getUTCDate(), p4, 2);
}
function formatUTCHour242(d4, p4) {
  return pad2(d4.getUTCHours(), p4, 2);
}
function formatUTCHour122(d4, p4) {
  return pad2(d4.getUTCHours() % 12 || 12, p4, 2);
}
function formatUTCDayOfYear2(d4, p4) {
  return pad2(1 + utcDay_default.count(utcYear_default(d4), d4), p4, 3);
}
function formatUTCMilliseconds2(d4, p4) {
  return pad2(d4.getUTCMilliseconds(), p4, 3);
}
function formatUTCMicroseconds2(d4, p4) {
  return formatUTCMilliseconds2(d4, p4) + "000";
}
function formatUTCMonthNumber2(d4, p4) {
  return pad2(d4.getUTCMonth() + 1, p4, 2);
}
function formatUTCMinutes2(d4, p4) {
  return pad2(d4.getUTCMinutes(), p4, 2);
}
function formatUTCSeconds2(d4, p4) {
  return pad2(d4.getUTCSeconds(), p4, 2);
}
function formatUTCWeekdayNumberMonday2(d4) {
  var dow = d4.getUTCDay();
  return dow === 0 ? 7 : dow;
}
function formatUTCWeekNumberSunday2(d4, p4) {
  return pad2(utcSunday2.count(utcYear_default(d4) - 1, d4), p4, 2);
}
function UTCdISO2(d4) {
  var day2 = d4.getUTCDay();
  return day2 >= 4 || day2 === 0 ? utcThursday2(d4) : utcThursday2.ceil(d4);
}
function formatUTCWeekNumberISO2(d4, p4) {
  d4 = UTCdISO2(d4);
  return pad2(utcThursday2.count(utcYear_default(d4), d4) + (utcYear_default(d4).getUTCDay() === 4), p4, 2);
}
function formatUTCWeekdayNumberSunday2(d4) {
  return d4.getUTCDay();
}
function formatUTCWeekNumberMonday2(d4, p4) {
  return pad2(utcMonday2.count(utcYear_default(d4) - 1, d4), p4, 2);
}
function formatUTCYear2(d4, p4) {
  return pad2(d4.getUTCFullYear() % 100, p4, 2);
}
function formatUTCYearISO2(d4, p4) {
  d4 = UTCdISO2(d4);
  return pad2(d4.getUTCFullYear() % 100, p4, 2);
}
function formatUTCFullYear2(d4, p4) {
  return pad2(d4.getUTCFullYear() % 1e4, p4, 4);
}
function formatUTCFullYearISO2(d4, p4) {
  var day2 = d4.getUTCDay();
...
function formatUnixTimestamp2(d4) {
  return +d4;
}
function formatUnixTimestampSeconds2(d4) {
  return Math.floor(+d4 / 1e3);
}
...
var Wr = (0, import_react16.createContext)();
var Lr = function(e8) {
  var t7 = e8.children, n5 = e8.animate, o5 = void 0 === n5 || n5, i5 = e8.config, a6 = void 0 === i5 ? "default" : i5, l6 = (0, import_react16.useMemo)(function() {
    var e9 = (0, import_isString.default)(a6) ? config[a6] : a6;
    return { animate: o5, config: e9 };
  }, [o5, a6]);
  return (0, import_jsx_runtime2.jsx)(Wr.Provider, { value: l6, children: t7 });
};
var Yr = function() {
  return (0, import_react16.useContext)(Wr);
};
var Ar = function(e8) {
  var r5 = e8.children, t7 = e8.condition, o5 = e8.wrapper;
  return t7 ? (0, import_react16.cloneElement)(o5, {}, r5) : r5;
};
var Sr = { position: "relative" };
var qr = function(e8) {
  var r5 = e8.children, t7 = e8.theme, n5 = e8.renderWrapper, i5 = void 0 === n5 || n5, a6 = e8.isInteractive, l6 = void 0 === a6 || a6, d4 = e8.animate, u5 = e8.motionConfig, s5 = (0, import_react16.useRef)(null);
  return (0, import_jsx_runtime2.jsx)(x, { theme: t7, children: (0, import_jsx_runtime2.jsx)(Lr, { animate: d4, config: u5, children: (0, import_jsx_runtime2.jsx)(W, { container: s5, children: (0, import_jsx_runtime2.jsxs)(Ar, { condition: i5, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Sr, ref: s5 }), children: [r5, l6 && (0, import_jsx_runtime2.jsx)(M, {})] }) }) }) });
};
var Fr = function(e8) {
  var t7 = Yr(), n5 = t7.animate, i5 = t7.config, l6 = function(e9) {
    var r5 = (0, import_react16.useRef)();
    return (0, import_react16.useEffect)(function() {
      r5.current = e9;
    }, [e9]), r5.current;
  }(e8), d4 = (0, import_react16.useMemo)(function() {
    return string_default(l6, e8);
  }, [l6, e8]), u5 = useSpring({ from: { value: 0 }, to: { value: 1 }, reset: true, config: i5, immediate: !n5 }).value;
  return to2(u5, d4);
};
var Ur = { basis: basis_default2, basisClosed: basisClosed_default2, basisOpen: basisOpen_default, bundle: bundle_default, cardinal: cardinal_default, cardinalClosed: cardinalClosed_default, cardinalOpen: cardinalOpen_default, catmullRom: catmullRom_default, catmullRomClosed: catmullRomClosed_default, catmullRomOpen: catmullRomOpen_default, linear: linear_default, linearClosed: linearClosed_default, monotoneX, monotoneY, natural: natural_default, step: step_default, stepAfter, stepBefore };
var Xr = Object.keys(Ur);
var Hr = Xr.filter(function(e8) {
  return e8.endsWith("Closed");
});
var Kr = (0, import_without.default)(Xr, "bundle", "basisClosed", "basisOpen", "cardinalClosed", "cardinalOpen", "catmullRomClosed", "catmullRomOpen", "linearClosed");
var Nr = (0, import_without.default)(Xr, "bundle", "basisClosed", "basisOpen", "cardinalClosed", "cardinalOpen", "catmullRomClosed", "catmullRomOpen", "linearClosed");
var Jr = function(e8) {
  if (!Ur[e8]) throw new TypeError("'" + e8 + "', is not a valid curve interpolator identifier.");
  return Ur[e8];
};
var Qr = { ascending: ascending_default, descending: descending_default2, insideOut: insideOut_default, none: none_default2, reverse: reverse_default };
var Vr = Object.keys(Qr);
var $r = { expand: expand_default, diverging: diverging_default, none: none_default, silhouette: silhouette_default, wiggle: wiggle_default };
var et = Object.keys($r);
function ot() {
  return ot = Object.assign ? Object.assign.bind() : function(e8) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var t7 = arguments[r5];
      for (var n5 in t7) ({}).hasOwnProperty.call(t7, n5) && (e8[n5] = t7[n5]);
    }
    return e8;
...
function it(e8, r5) {
  if (null == e8) return {};
  var t7 = {};
  for (var n5 in e8) if ({}.hasOwnProperty.call(e8, n5)) {
    if (-1 !== r5.indexOf(n5)) continue;
    t7[n5] = e8[n5];
  }
  return t7;
}
var lt = { nivo: ["#d76445", "#f47560", "#e8c1a0", "#97e3d5", "#61cdbb", "#00b0a7"], BrBG: (0, import_last.default)(scheme), PRGn: (0, import_last.default)(scheme2), PiYG: (0, import_last.default)(scheme3), PuOr: (0, import_last.default)(scheme4), RdBu: (0, import_last.default)(scheme5), RdGy: (0, import_last.default)(scheme6), RdYlBu: (0, import_last.default)(scheme7), RdYlGn: (0, import_last.default)(scheme8), spectral: (0, import_last.default)(scheme9), blues: (0, import_last.default)(scheme22), greens: (0, import_last.default)(scheme23), greys: (0, import_last.default)(scheme24), oranges: (0, import_last.default)(scheme27), purples: (0, import_last.default)(scheme25), reds: (0, import_last.default)(scheme26), BuGn: (0, import_last.default)(scheme10), BuPu: (0, import_last.default)(scheme11), GnBu: (0, import_last.default)(scheme12), OrRd: (0, import_last.default)(scheme13), PuBuGn: (0, import_last.default)(scheme14), PuBu: (0, import_last.default)(scheme15), PuRd: (0, import_last.default)(scheme16), RdPu: (0, import_last.default)(scheme17), YlGnBu: (0, import_last.default)(scheme18), YlGn: (0, import_last.default)(scheme19), YlOrBr: (0, import_last.default)(scheme20), YlOrRd: (0, import_last.default)(scheme21) };
var dt = Object.keys(lt);
...
var _t = function(e8, t7, n5) {
  return void 0 === n5 && (n5 = {}), (0, import_react16.useMemo)(function() {
    var r5 = ot({}, yt, n5);
    return { margin: r5, innerWidth: e8 - r5.left - r5.right, innerHeight: t7 - r5.top - r5.bottom, outerWidth: e8, outerHeight: t7 };
  }, [e8, t7, n5.top, n5.right, n5.bottom, n5.left]);
};
var wt = function() {
  var e8 = (0, import_react16.useRef)(null), r5 = (0, import_react16.useState)({ left: 0, top: 0, width: 0, height: 0 }), t7 = r5[0], n5 = r5[1], i5 = (0, import_react16.useState)(function() {
    return "undefined" == typeof ResizeObserver ? null : new ResizeObserver(function(e9) {
      var r6 = e9[0];
      return n5(r6.contentRect);
    });
  })[0];
  return (0, import_react16.useEffect)(function() {
...
var kt = function(e8) {
  return "function" == typeof e8 ? e8 : "string" == typeof e8 ? 0 === e8.indexOf("time:") ? timeFormat2(e8.slice("5")) : format2(e8) : function(e9) {
    return "" + e9;
  };
};
var xt = function(e8) {
...
var Ot = function(e8) {
  var r5 = e8.children, t7 = wt(), n5 = t7[0], o5 = t7[1], i5 = o5.width > 0 && o5.height > 0;
  return (0, import_jsx_runtime2.jsx)("div", { ref: n5, style: { width: "100%", height: "100%" }, children: i5 && r5({ width: o5.width, height: o5.height }) });
};
var Mt = ["id", "colors"];
var zt = function(e8) {
  var r5 = e8.id, t7 = e8.colors, n5 = it(e8, Mt);
  return (0, import_jsx_runtime2.jsx)("linearGradient", ot({ id: r5, x1: 0, x2: 0, y1: 0, y2: 1 }, n5, { children: t7.map(function(e9) {
    var r6 = e9.offset, t8 = e9.color, n6 = e9.opacity;
    return (0, import_jsx_runtime2.jsx)("stop", { offset: r6 + "%", stopColor: t8, stopOpacity: void 0 !== n6 ? n6 : 1 }, r6);
  }) }));
};
var jt = { linearGradient: zt };
var Pt = { color: "#000000", background: "#ffffff", size: 4, padding: 4, stagger: false };
var Bt = (0, import_react16.memo)(function(e8) {
  var r5 = e8.id, t7 = e8.background, n5 = void 0 === t7 ? Pt.background : t7, o5 = e8.color, i5 = void 0 === o5 ? Pt.color : o5, a6 = e8.size, l6 = void 0 === a6 ? Pt.size : a6, d4 = e8.padding, u5 = void 0 === d4 ? Pt.padding : d4, s5 = e8.stagger, c10 = void 0 === s5 ? Pt.stagger : s5, f4 = l6 + u5, h2 = l6 / 2, p4 = u5 / 2;
  return true === c10 && (f4 = 2 * l6 + 2 * u5), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: f4, height: f4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f4, height: f4, fill: n5 }), (0, import_jsx_runtime2.jsx)("circle", { cx: p4 + h2, cy: p4 + h2, r: h2, fill: i5 }), c10 && (0, import_jsx_runtime2.jsx)("circle", { cx: 1.5 * u5 + l6 + h2, cy: 1.5 * u5 + l6 + h2, r: h2, fill: i5 })] });
});
var Gt = 2 * Math.PI;
var Wt = function(e8) {
...
var Et = { svg: { align: { left: "start", center: "middle", right: "end", start: "start", middle: "middle", end: "end" }, baseline: { top: "text-before-edge", center: "central", bottom: "alphabetic" } }, canvas: { align: { left: "left", center: "center", right: "right", start: "left", middle: "center", end: "right" }, baseline: { top: "top", center: "middle", bottom: "bottom" } } };
var Ft = { spacing: 5, rotation: 0, background: "#000000", color: "#ffffff", lineWidth: 2 };
var Ut = (0, import_react16.memo)(function(e8) {
  var r5 = e8.id, t7 = e8.spacing, n5 = void 0 === t7 ? Ft.spacing : t7, o5 = e8.rotation, i5 = void 0 === o5 ? Ft.rotation : o5, a6 = e8.background, l6 = void 0 === a6 ? Ft.background : a6, d4 = e8.color, u5 = void 0 === d4 ? Ft.color : d4, s5 = e8.lineWidth, c10 = void 0 === s5 ? Ft.lineWidth : s5, f4 = Math.round(i5) % 360, h2 = Math.abs(n5);
  f4 > 180 ? f4 -= 360 : f4 > 90 ? f4 -= 180 : f4 < -180 ? f4 += 360 : f4 < -90 && (f4 += 180);
  var p4, g3 = h2, b2 = h2;
  return 0 === f4 ? p4 = "\n                M 0 0 L " + g3 + " 0\n                M 0 " + b2 + " L " + g3 + " " + b2 + "\n            " : 90 === f4 ? p4 = "\n                M 0 0 L 0 " + b2 + "\n                M " + g3 + " 0 L " + g3 + " " + b2 + "\n            " : (g3 = Math.abs(h2 / Math.sin(Wt(f4))), b2 = h2 / Math.sin(Wt(90 - f4)), p4 = f4 > 0 ? "\n                    M 0 " + -b2 + " L " + 2 * g3 + " " + b2 + "\n                    M " + -g3 + " " + -b2 + " L " + g3 + " " + b2 + "\n                    M " + -g3 + " 0 L " + g3 + " " + 2 * b2 + "\n                " : "\n                    M " + -g3 + " " + b2 + " L " + g3 + " " + -b2 + "\n                    M " + -g3 + " " + 2 * b2 + " L " + 2 * g3 + " " + -b2 + "\n                    M 0 " + 2 * b2 + " L " + 2 * g3 + " 0\n                "), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: g3, height: b2, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: g3, height: b2, fill: l6, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime2.jsx)("path", { d: p4, strokeWidth: c10, stroke: u5, strokeLinecap: "square" })] });
});
var Ht = { color: "#000000", background: "#ffffff", size: 4, padding: 4, stagger: false };
var Kt = (0, import_react16.memo)(function(e8) {
  var r5 = e8.id, t7 = e8.color, n5 = void 0 === t7 ? Ht.color : t7, o5 = e8.background, i5 = void 0 === o5 ? Ht.background : o5, a6 = e8.size, l6 = void 0 === a6 ? Ht.size : a6, d4 = e8.padding, u5 = void 0 === d4 ? Ht.padding : d4, s5 = e8.stagger, c10 = void 0 === s5 ? Ht.stagger : s5, f4 = l6 + u5, h2 = u5 / 2;
  return true === c10 && (f4 = 2 * l6 + 2 * u5), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: f4, height: f4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f4, height: f4, fill: i5 }), (0, import_jsx_runtime2.jsx)("rect", { x: h2, y: h2, width: l6, height: l6, fill: n5 }), c10 && (0, import_jsx_runtime2.jsx)("rect", { x: 1.5 * u5 + l6, y: 1.5 * u5 + l6, width: l6, height: l6, fill: n5 })] });
});
var Jt = { patternDots: Bt, patternLines: Ut, patternSquares: Kt };
var Qt = ["type"];
var Vt = ot({}, jt, Jt);
var Zt = (0, import_react16.memo)(function(e8) {
  var r5 = e8.defs;
  return !r5 || r5.length < 1 ? null : (0, import_jsx_runtime2.jsx)("defs", { "aria-hidden": true, children: r5.map(function(e9) {
    var r6 = e9.type, t7 = it(e9, Qt);
    return Vt[r6] ? (0, import_react16.createElement)(Vt[r6], ot({ key: t7.id }, t7)) : null;
  }) });
});
var $t = function(e8) {
  var r5 = e8.width, t7 = e8.height, n5 = e8.margin, o5 = e8.defs, i5 = e8.children, a6 = e8.role, l6 = e8.ariaLabel, d4 = e8.ariaLabelledBy, u5 = e8.ariaDescribedBy, s5 = e8.isFocusable, c10 = k();
  return (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: r5, height: t7, role: a6, "aria-label": l6, "aria-labelledby": d4, "aria-describedby": u5, focusable: s5, tabIndex: s5 ? 0 : void 0, children: [(0, import_jsx_runtime2.jsx)(Zt, { defs: o5 }), (0, import_jsx_runtime2.jsx)("rect", { width: r5, height: t7, fill: c10.background }), (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + n5.left + "," + n5.top + ")", children: i5 })] });
};
var en = (0, import_react16.memo)(function(e8) {
  var r5 = e8.size, t7 = e8.color, n5 = e8.borderWidth, o5 = e8.borderColor;
  return (0, import_jsx_runtime2.jsx)("circle", { r: r5 / 2, fill: t7, stroke: o5, strokeWidth: n5, style: { pointerEvents: "none" } });
});
var rn = (0, import_react16.memo)(function(e8) {
  var r5 = e8.x, t7 = e8.y, n5 = e8.symbol, o5 = void 0 === n5 ? en : n5, a6 = e8.size, l6 = e8.datum, d4 = e8.color, s5 = e8.borderWidth, c10 = e8.borderColor, f4 = e8.label, h2 = e8.labelTextAnchor, p4 = void 0 === h2 ? "middle" : h2, g3 = e8.labelYOffset, b2 = void 0 === g3 ? -12 : g3, y5 = e8.ariaLabel, _ = e8.ariaLabelledBy, k5 = e8.ariaDescribedBy, z2 = e8.ariaHidden, C5 = e8.ariaDisabled, j3 = e8.isFocusable, P2 = void 0 !== j3 && j3, B3 = e8.tabIndex, R = void 0 === B3 ? 0 : B3, G = e8.onFocus, W2 = e8.onBlur, I = e8.testId, L = k(), Y2 = Yr(), A4 = Y2.animate, S2 = Y2.config, q = useSpring({ transform: "translate(" + r5 + ", " + t7 + ")", config: S2, immediate: !A4 }), D2 = (0, import_react16.useCallback)(function(e9) {
    null == G || G(l6, e9);
  }, [G, l6]), E4 = (0, import_react16.useCallback)(function(e9) {
    null == W2 || W2(l6, e9);
  }, [W2, l6]);
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: q.transform, style: { pointerEvents: "none" }, focusable: P2, tabIndex: P2 ? R : void 0, "aria-label": y5, "aria-labelledby": _, "aria-describedby": k5, "aria-disabled": C5, "aria-hidden": z2, onFocus: P2 && G ? D2 : void 0, onBlur: P2 && W2 ? E4 : void 0, "data-testid": I, children: [(0, import_react16.createElement)(o5, { size: a6, color: d4, datum: l6, borderWidth: s5, borderColor: c10 }), f4 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p4, y: b2, style: g(L.dots.text), children: f4 })] });
});
var tn = (0, import_react16.memo)(function(e8) {
  var r5 = e8.width, t7 = e8.height, n5 = e8.axis, o5 = e8.scale, i5 = e8.value, a6 = e8.lineStyle, l6 = e8.textStyle, d4 = e8.legend, u5 = e8.legendNode, s5 = e8.legendPosition, c10 = void 0 === s5 ? "top-right" : s5, f4 = e8.legendOffsetX, h2 = void 0 === f4 ? 14 : f4, p4 = e8.legendOffsetY, g3 = void 0 === p4 ? 14 : p4, b2 = e8.legendOrientation, v3 = void 0 === b2 ? "horizontal" : b2, y5 = k(), _ = 0, w2 = 0, k5 = 0, x5 = 0;
  if ("y" === n5 ? (k5 = o5(i5), w2 = r5) : (_ = o5(i5), x5 = t7), d4 && !u5) {
    var z2 = function(e9) {
      var r6 = e9.axis, t8 = e9.width, n6 = e9.height, o6 = e9.position, i6 = e9.offsetX, a7 = e9.offsetY, l7 = e9.orientation, d5 = 0, u6 = 0, s6 = "vertical" === l7 ? -90 : 0, c11 = "start";
      if ("x" === r6) switch (o6) {
        case "top-left":
          d5 = -i6, u6 = a7, c11 = "end";
          break;
        case "top":
          u6 = -a7, c11 = "horizontal" === l7 ? "middle" : "start";
          break;
        case "top-right":
          d5 = i6, u6 = a7, c11 = "horizontal" === l7 ? "start" : "end";
          break;
        case "right":
          d5 = i6, u6 = n6 / 2, c11 = "horizontal" === l7 ? "start" : "middle";
          break;
        case "bottom-right":
          d5 = i6, u6 = n6 - a7, c11 = "start";
          break;
        case "bottom":
          u6 = n6 + a7, c11 = "horizontal" === l7 ? "middle" : "end";
          break;
        case "bottom-left":
          u6 = n6 - a7, d5 = -i6, c11 = "horizontal" === l7 ? "end" : "start";
          break;
        case "left":
          d5 = -i6, u6 = n6 / 2, c11 = "horizontal" === l7 ? "end" : "middle";
      }
      else switch (o6) {
        case "top-left":
          d5 = i6, u6 = -a7, c11 = "start";
          break;
        case "top":
          d5 = t8 / 2, u6 = -a7, c11 = "horizontal" === l7 ? "middle" : "start";
          break;
        case "top-right":
          d5 = t8 - i6, u6 = -a7, c11 = "horizontal" === l7 ? "end" : "start";
          break;
        case "right":
          d5 = t8 + i6, c11 = "horizontal" === l7 ? "start" : "middle";
          break;
        case "bottom-right":
          d5 = t8 - i6, u6 = a7, c11 = "end";
          break;
        case "bottom":
          d5 = t8 / 2, u6 = a7, c11 = "horizontal" === l7 ? "middle" : "end";
          break;
        case "bottom-left":
          d5 = i6, u6 = a7, c11 = "horizontal" === l7 ? "start" : "end";
          break;
        case "left":
          d5 = -i6, c11 = "horizontal" === l7 ? "end" : "middle";
      }
      return { x: d5, y: u6, rotation: s6, textAnchor: c11 };
    }({ axis: n5, width: r5, height: t7, position: c10, offsetX: h2, offsetY: g3, orientation: v3 });
    u5 = (0, import_jsx_runtime2.jsx)("text", { transform: "translate(" + z2.x + ", " + z2.y + ") rotate(" + z2.rotation + ")", textAnchor: z2.textAnchor, dominantBaseline: "central", style: l6, children: d4 });
  }
  return (0, import_jsx_runtime2.jsxs)("g", { transform: "translate(" + _ + ", " + k5 + ")", children: [(0, import_jsx_runtime2.jsx)("line", { x1: 0, x2: w2, y1: 0, y2: x5, stroke: y5.markers.lineColor, strokeWidth: y5.markers.lineStrokeWidth, style: a6 }), u5] });
});
var nn = (0, import_react16.memo)(function(e8) {
  var r5 = e8.markers, t7 = e8.width, n5 = e8.height, o5 = e8.xScale, i5 = e8.yScale;
  return r5 && 0 !== r5.length ? r5.map(function(e9, r6) {
    return (0, import_jsx_runtime2.jsx)(tn, ot({}, e9, { width: t7, height: n5, scale: "y" === e9.axis ? i5 : o5 }), r6);
  }) : null;
});
var ln = function(e8, r5) {
  var t7, n5 = (0, import_isFunction.default)(e8) ? e8 : function(r6) {
    return (0, import_get2.default)(r6, e8);
  };
  return r5 && (t7 = (0, import_isFunction.default)(r5) ? r5 : format2(r5)), t7 ? function(e9) {
    return t7(n5(e9));
  } : n5;
};
var dn = function(e8) {
...
var fn = function(e8, r5, t7, n5) {
  return Math.sqrt(Math.pow(t7 - e8, 2) + Math.pow(n5 - r5, 2));
};
var hn = function(e8, r5, t7, n5) {
  var o5 = Math.atan2(n5 - r5, t7 - e8) - Math.PI / 2;
  return o5 > 0 ? o5 : 2 * Math.PI + o5;
};
var pn = function(e8, r5, t7, n5, o5, i5) {
  return e8 <= o5 && o5 <= e8 + t7 && r5 <= i5 && i5 <= r5 + n5;
};
var gn = function(e8, r5) {
  var t7, n5 = "touches" in r5 ? r5.touches[0] : r5, o5 = n5.clientX, i5 = n5.clientY, a6 = e8.getBoundingClientRect(), l6 = (t7 = void 0 !== e8.getBBox ? e8.getBBox() : { width: e8.offsetWidth || 0, height: e8.offsetHeight || 0 }).width === a6.width ? 1 : t7.width / a6.width;
  return [(o5 - a6.left) * l6, (i5 - a6.top) * l6];
};
var bn = Object.keys(jt);
var mn = Object.keys(Jt);
var vn = function(e8, r5, t7) {
  if ("*" === e8) return true;
  if ((0, import_isFunction.default)(e8)) return e8(r5);
  if ((0, import_isPlainObject.default)(e8)) {
    var n5 = t7 ? (0, import_get2.default)(r5, t7) : r5;
    return (0, import_isEqual.default)((0, import_pick.default)(n5, Object.keys(e8)), e8);
  }
  return false;
};
var yn = function(e8, r5, t7, n5) {
  var o5 = void 0 === n5 ? {} : n5, i5 = o5.dataKey, a6 = o5.colorKey, l6 = void 0 === a6 ? "color" : a6, d4 = o5.targetKey, u5 = void 0 === d4 ? "fill" : d4, s5 = [], c10 = {};
  return e8.length && r5.length && (s5 = [].concat(e8), r5.forEach(function(r6) {
    for (var n6 = function() {
      var n7 = t7[o6], a7 = n7.id, d5 = n7.match;
      if (vn(d5, r6, i5)) {
        var f4 = e8.find(function(e9) {
          return e9.id === a7;
        });
        if (f4) {
          if (mn.includes(f4.type)) if ("inherit" === f4.background || "inherit" === f4.color) {
            var h2 = (0, import_get2.default)(r6, l6), p4 = f4.background, g3 = f4.color, b2 = a7;
            "inherit" === f4.background && (b2 = b2 + ".bg." + h2, p4 = h2), "inherit" === f4.color && (b2 = b2 + ".fg." + h2, g3 = h2), (0, import_set3.default)(r6, u5, "url(#" + b2 + ")"), c10[b2] || (s5.push(ot({}, f4, { id: b2, background: p4, color: g3 })), c10[b2] = 1);
          } else (0, import_set3.default)(r6, u5, "url(#" + a7 + ")");
          else if (bn.includes(f4.type)) {
            if (f4.colors.map(function(e9) {
              return e9.color;
            }).includes("inherit")) {
              var m3 = (0, import_get2.default)(r6, l6), v3 = a7, y5 = ot({}, f4, { colors: f4.colors.map(function(e9, r7) {
                return "inherit" !== e9.color ? e9 : (v3 = v3 + "." + r7 + "." + m3, ot({}, e9, { color: "inherit" === e9.color ? m3 : e9.color }));
              }) });
              y5.id = v3, (0, import_set3.default)(r6, u5, "url(#" + v3 + ")"), c10[v3] || (s5.push(y5), c10[v3] = 1);
            } else (0, import_set3.default)(r6, u5, "url(#" + a7 + ")");
          }
        }
        return 1;
      }
    }, o6 = 0; o6 < t7.length && !n6(); o6++) ;
  })), s5;
};
function _n() {
  for (var e8 = arguments.length, r5 = new Array(e8), t7 = 0; t7 < e8; t7++) r5[t7] = arguments[t7];
  return function(e9) {
    for (var t8 = 0, n5 = r5; t8 < n5.length; t8++) {
      var o5 = n5[t8];
...
function v() {
  return v = Object.assign ? Object.assign.bind() : function(t7) {
    for (var i5 = 1; i5 < arguments.length; i5++) {
      var n5 = arguments[i5];
      for (var o5 in n5) ({}).hasOwnProperty.call(n5, o5) && (t7[o5] = n5[o5]);
    }
    return t7;
  }, v.apply(null, arguments);
}
var x3 = ["basic", "chip", "container", "table", "tableCell", "tableCellValue"];
var m2 = { pointerEvents: "none", position: "absolute", zIndex: 10, top: 0, left: 0 };
var b = function(t7, i5) {
  return "translate(" + t7 + "px, " + i5 + "px)";
};
var g2 = (0, import_react17.memo)(function(t7) {
  var n5, o5 = t7.position, r5 = t7.anchor, e8 = t7.children, l6 = k(), u5 = Yr(), y5 = u5.animate, f4 = u5.config, g3 = wt(), w2 = g3[0], T2 = g3[1], C5 = (0, import_react17.useRef)(false), E4 = void 0, P2 = false, V2 = T2.width > 0 && T2.height > 0, O4 = Math.round(o5[0]), N2 = Math.round(o5[1]);
  V2 && ("top" === r5 ? (O4 -= T2.width / 2, N2 -= T2.height + 14) : "right" === r5 ? (O4 += 14, N2 -= T2.height / 2) : "bottom" === r5 ? (O4 -= T2.width / 2, N2 += 14) : "left" === r5 ? (O4 -= T2.width + 14, N2 -= T2.height / 2) : "center" === r5 && (O4 -= T2.width / 2, N2 -= T2.height / 2), E4 = { transform: b(O4, N2) }, C5.current || (P2 = true), C5.current = [O4, N2]);
  var j3 = useSpring({ to: E4, config: f4, immediate: !y5 || P2 }), k5 = l6.tooltip;
  k5.basic, k5.chip, k5.container, k5.table, k5.tableCell, k5.tableCellValue;
  var z2 = function(t8, i5) {
    if (null == t8) return {};
    var n6 = {};
    ...
    return n6;
  }(k5, x3), A4 = v({}, m2, z2, { transform: null != (n5 = j3.transform) ? n5 : b(O4, N2), opacity: j3.transform ? 1 : 0 });
  return (0, import_jsx_runtime3.jsx)(animated.div, { ref: w2, style: A4, children: e8 });
});
g2.displayName = "TooltipWrapper";
var w = (0, import_react17.memo)(function(t7) {
  var i5 = t7.size, n5 = void 0 === i5 ? 12 : i5, o5 = t7.color, r5 = t7.style;
  return (0, import_jsx_runtime3.jsx)("span", { style: v({ display: "block", width: n5, height: n5, background: o5 }, void 0 === r5 ? {} : r5) });
});
var T = (0, import_react17.memo)(function(t7) {
  var i5, n5 = t7.id, o5 = t7.value, r5 = t7.format, e8 = t7.enableChip, l6 = void 0 !== e8 && e8, a6 = t7.color, c10 = t7.renderContent, s5 = k(), h2 = xt(r5);
  if ("function" == typeof c10) i5 = c10();
  else {
    var f4 = o5;
    void 0 !== h2 && void 0 !== f4 && (f4 = h2(f4)), i5 = (0, import_jsx_runtime3.jsxs)("div", { style: s5.tooltip.basic, children: [l6 && (0, import_jsx_runtime3.jsx)(w, { color: a6, style: s5.tooltip.chip }), void 0 !== f4 ? (0, import_jsx_runtime3.jsxs)("span", { children: [n5, ": ", (0, import_jsx_runtime3.jsx)("strong", { children: "" + f4 })] }) : n5] });
  }
  return (0, import_jsx_runtime3.jsx)("div", { style: s5.tooltip.container, children: i5 });
});
var C3 = { width: "100%", borderCollapse: "collapse" };
var E2 = (0, import_react17.memo)(function(t7) {
  var i5, n5 = t7.title, o5 = t7.rows, r5 = void 0 === o5 ? [] : o5, e8 = t7.renderContent, l6 = k();
  return r5.length ? (i5 = "function" == typeof e8 ? e8() : (0, import_jsx_runtime3.jsxs)("div", { children: [n5 && n5, (0, import_jsx_runtime3.jsx)("table", { style: v({}, C3, l6.tooltip.table), children: (0, import_jsx_runtime3.jsx)("tbody", { children: r5.map(function(t8, i6) {
...
var P = (0, import_react17.memo)(function(t7) {
  var i5 = t7.x0, o5 = t7.x1, r5 = t7.y0, e8 = t7.y1, l6 = k(), h2 = Yr(), u5 = h2.animate, y5 = h2.config, f4 = (0, import_react17.useMemo)(function() {
    return v({}, l6.crosshair.line, { pointerEvents: "none" });
  }, [l6.crosshair.line]), x5 = useSpring({ x1: i5, x2: o5, y1: r5, y2: e8, config: y5, immediate: !u5 });
  return (0, import_jsx_runtime3.jsx)(animated.line, v({}, x5, { fill: "none", style: f4 }));
});
P.displayName = "CrosshairLine";
var V = (0, import_react17.memo)(function(t7) {
  var i5, n5, o5 = t7.width, r5 = t7.height, e8 = t7.type, l6 = t7.x, a6 = t7.y;
  return "cross" === e8 ? (i5 = { x0: l6, x1: l6, y0: 0, y1: r5 }, n5 = { x0: 0, x1: o5, y0: a6, y1: a6 }) : "top-left" === e8 ? (i5 = { x0: l6, x1: l6, y0: 0, y1: a6 }, n5 = { x0: 0, x1: l6, y0: a6, y1: a6 }) : "top" === e8 ? i5 = { x0: l6, x1: l6, y0: 0, y1: a6 } : "top-right" === e8 ? (i5 = { x0: l6, x1: l6, y0: 0, y1: a6 }, n5 = { x0: l6, x1: o5, y0: a6, y1: a6 }) : "right" === e8 ? n5 = { x0: l6, x1: o5, y0: a6, y1: a6 } : "bottom-right" === e8 ? (i5 = { x0: l6, x1: l6, y0: a6, y1: r5 }, n5 = { x0: l6, x1: o5, y0: a6, y1: a6 }) : "bottom" === e8 ? i5 = { x0: l6, x1: l6, y0: a6, y1: r5 } : "bottom-left" === e8 ? (i5 = { x0: l6, x1: l6, y0: a6, y1: r5 }, n5 = { x0: 0, x1: l6, y0: a6, y1: a6 }) : "left" === e8 ? n5 = { x0: 0, x1: l6, y0: a6, y1: a6 } : "x" === e8 ? i5 = { x0: l6, x1: l6, y0: 0, y1: r5 } : "y" === e8 && (n5 = { x0: 0, x1: o5, y0: a6, y1: a6 }), (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [i5 && (0, import_jsx_runtime3.jsx)(P, { x0: i5.x0, x1: i5.x1, y0: i5.y0, y1: i5.y1 }), n5 && (0, import_jsx_runtime3.jsx)(P, { x0: n5.x0, x1: n5.x1, y0: n5.y0, y1: n5.y1 })] });
});
V.displayName = "Crosshair";
var O = (0, import_react17.createContext)({ showTooltipAt: function() {
}, showTooltipFromEvent: function() {
}, hideTooltip: function() {
} });
var N = { isVisible: false, position: [null, null], content: null, anchor: null };
var j = (0, import_react17.createContext)(N);
var k3 = function(t7) {
  var i5 = (0, import_react17.useState)(N), o5 = i5[0], l6 = i5[1], a6 = (0, import_react17.useCallback)(function(t8, i6, n5) {
    var o6 = i6[0], r5 = i6[1];
    void 0 === n5 && (n5 = "top"), l6({ isVisible: true, position: [o6, r5], anchor: n5, content: t8 });
  }, [l6]), c10 = (0, import_react17.useCallback)(function(i6, n5, o6) {
    void 0 === o6 && (o6 = "top");
    var r5 = t7.current.getBoundingClientRect(), e8 = t7.current.offsetWidth, a7 = e8 === r5.width ? 1 : e8 / r5.width, c11 = "touches" in n5 ? n5.touches[0] : n5, s6 = c11.clientX, h2 = c11.clientY, u5 = (s6 - r5.left) * a7, d4 = (h2 - r5.top) * a7;
    "left" !== o6 && "right" !== o6 || (o6 = u5 < r5.width / 2 ? "right" : "left"), l6({ isVisible: true, position: [u5, d4], anchor: o6, content: i6 });
  }, [t7, l6]), s5 = (0, import_react17.useCallback)(function() {
    l6(N);
  }, [l6]);
  return { actions: (0, import_react17.useMemo)(function() {
    return { showTooltipAt: a6, showTooltipFromEvent: c10, hideTooltip: s5 };
  }, [a6, c10, s5]), state: o5 };
};
var z = function() {
  var t7 = (0, import_react17.useContext)(O);
  if (void 0 === t7) throw new Error("useTooltip must be used within a TooltipProvider");
  return t7;
};
var A2 = function() {
  var t7 = (0, import_react17.useContext)(j);
...
var M = function() {
  var t7 = A2();
  return F(t7) ? (0, import_jsx_runtime3.jsx)(g2, { position: t7.position, anchor: t7.anchor, children: t7.content }) : null;
};
var W = function(t7) {
  var i5 = t7.container, n5 = t7.children, o5 = k3(i5), r5 = o5.actions, e8 = o5.state;
  return (0, import_jsx_runtime3.jsx)(O.Provider, { value: r5, children: (0, import_jsx_runtime3.jsx)(j.Provider, { value: e8, children: n5 }) });
};

// node_modules/@nivo/text/dist/nivo-text.mjs
var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
var r4 = function(t7, n5) {
  t7.font = (n5.fontWeight ? n5.fontWeight + " " : "") + n5.fontSize + "px " + n5.fontFamily;
};
var o4 = function(t7, n5, i5, e8, r5) {
  void 0 === e8 && (e8 = 0), void 0 === r5 && (r5 = 0), n5.outlineWidth > 0 && (t7.strokeStyle = n5.outlineColor, t7.lineWidth = 2 * n5.outlineWidth, t7.lineJoin = "round", t7.strokeText(i5, e8, r5)), t7.fillStyle = n5.fill, t7.fillText(i5, e8, r5);
};
function l4() {
  return l4 = Object.assign ? Object.assign.bind() : function(t7) {
    for (var n5 = 1; n5 < arguments.length; n5++) {
      var i5 = arguments[n5];
      for (var e8 in i5) ({}).hasOwnProperty.call(i5, e8) && (t7[e8] = i5[e8]);
    }
    return t7;
...
function u3(t7, n5) {
  if (null == t7) return {};
  var i5 = {};
  for (var e8 in t7) if ({}.hasOwnProperty.call(t7, e8)) {
    if (-1 !== n5.indexOf(e8)) continue;
    i5[e8] = t7[e8];
  }
  return i5;
}
var f3 = ["style", "children"];
var a4 = ["outlineWidth", "outlineColor", "outlineOpacity"];
var c8 = function(r5) {
  var o5 = r5.style, c10 = r5.children, s5 = u3(r5, f3), d4 = o5.outlineWidth, h2 = o5.outlineColor, y5 = o5.outlineOpacity, p4 = u3(o5, a4);
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [d4 > 0 && (0, import_jsx_runtime4.jsx)(animated.text, l4({}, s5, { style: l4({}, p4, { strokeWidth: 2 * d4, stroke: h2, strokeOpacity: y5, strokeLinejoin: "round" }), children: c10 })), (0, import_jsx_runtime4.jsx)(animated.text, l4({}, s5, { style: p4, children: c10 }))] });
};
...
function Se(e8, r5) {
  ...
  for (var n5 = 0, t7 = Array(r5); n5 < r5; n5++) t7[n5] = e8[n5];
  return t7;
}
function Ce(e8, r5) {
  ...
  if (Array.isArray(e8) || (n5 = function(e9, r6) {
    if (e9) {
      ...
      var n6 = {}.toString.call(e9).slice(8, -1);
      return "Object" === n6 && e9.constructor && (n6 = e9.constructor.name), "Map" === n6 || "Set" === n6 ? Array.from(e9) : "Arguments" === n6 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n6) ? Se(e9, r6) : void 0;
    }
...
function Ge() {
  return Ge = Object.assign ? Object.assign.bind() : function(e8) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var n5 = arguments[r5];
      for (var t7 in n5) ({}).hasOwnProperty.call(n5, t7) && (e8[t7] = n5[t7]);
    }
    return e8;
...
var Xe = function(e8, r5) {
  ...
  if ((0, import_isPlainObject2.default)(e8)) {
    if (Qe(e8)) {
      ...
      var n5 = (0, import_get3.default)(r5, e8.theme);
    ...
    if (We(e8)) {
      ...
      if (Array.isArray(e8.modifiers)) {
        for (var o5, i5 = [], u5 = function() {
          var e9 = o5.value, r6 = e9[0], n6 = e9[1];
        ...
        }, l6 = Ce(e8.modifiers); !(o5 = l6()).done; ) u5();
  ...
  if ((0, import_isPlainObject2.default)(e8)) {
    ...
    if (function(e9) {
      ...
      if (He(e8.scheme)) {
        ...
        var l6 = ordinal($e[e8.scheme][e8.size || 11]), a6 = function(e9) {
          return l6(n5(e9));
        };
      ...
      if (Je(e8.scheme)) {
        ...
        var c10 = ordinal($e[e8.scheme][e8.size || 9]), s5 = function(e9) {
          return c10(n5(e9));
        };
...
var v2 = function(e8) {
  var i5 = e8.x, n5 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a6 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, d4 = void 0 === c10 ? 0 : c10, s5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("circle", { r: o5 / 2, cx: i5 + o5 / 2, cy: n5 + o5 / 2, fill: r5, opacity: a6, strokeWidth: d4, stroke: void 0 === s5 ? "transparent" : s5, style: { pointerEvents: "none" } });
};
var u4 = function(e8) {
  var i5 = e8.x, n5 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a6 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, d4 = void 0 === c10 ? 0 : c10, s5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + i5 + "," + n5 + ")", children: (0, import_jsx_runtime5.jsx)("path", { d: "\n                    M" + o5 / 2 + " 0\n                    L" + 0.8 * o5 + " " + o5 / 2 + "\n                    L" + o5 / 2 + " " + o5 + "\n                    L" + 0.2 * o5 + " " + o5 / 2 + "\n                    L" + o5 / 2 + " 0\n                ", fill: r5, opacity: a6, strokeWidth: d4, stroke: void 0 === s5 ? "transparent" : s5, style: { pointerEvents: "none" } }) });
};
var p3 = function(e8) {
  var i5 = e8.x, n5 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a6 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, d4 = void 0 === c10 ? 0 : c10, s5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("rect", { x: i5, y: n5, fill: r5, opacity: a6, strokeWidth: d4, stroke: void 0 === s5 ? "transparent" : s5, width: o5, height: o5, style: { pointerEvents: "none" } });
};
var y4 = function(e8) {
  var i5 = e8.x, n5 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a6 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, d4 = void 0 === c10 ? 0 : c10, s5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + i5 + "," + n5 + ")", children: (0, import_jsx_runtime5.jsx)("path", { d: "\n                M" + o5 / 2 + " 0\n                L" + o5 + " " + o5 + "\n                L0 " + o5 + "\n                L" + o5 / 2 + " 0\n            ", fill: r5, opacity: a6, strokeWidth: d4, stroke: void 0 === s5 ? "transparent" : s5, style: { pointerEvents: "none" } }) });
...
function k4() {
  return k4 = Object.assign ? Object.assign.bind() : function(t7) {
    for (var e8 = 1; e8 < arguments.length; e8++) {
      var i5 = arguments[e8];
      for (var n5 in i5) ({}).hasOwnProperty.call(i5, n5) && (t7[n5] = i5[n5]);
    }
    return t7;
  }, k4.apply(null, arguments);
}
var x4 = { top: 0, right: 0, bottom: 0, left: 0 };
var S = function(t7) {
  var e8, i5 = t7.direction, n5 = t7.itemsSpacing, o5 = t7.padding, r5 = t7.itemCount, l6 = t7.itemWidth, a6 = t7.itemHeight;
  ...
  var c10 = "number" == typeof o5 ? { top: o5, right: o5, bottom: o5, left: o5 } : k4({}, x4, o5), d4 = c10.left + c10.right, s5 = c10.top + c10.bottom, h2 = l6 + d4, g3 = a6 + s5, m3 = (r5 - 1) * n5;
  return "row" === i5 ? h2 = l6 * r5 + m3 + d4 : "column" === i5 && (g3 = a6 * r5 + m3 + s5), { width: h2, height: g3, padding: c10 };
};
var A3 = function(t7) {
  var e8 = t7.anchor, i5 = t7.translateX, n5 = t7.translateY, o5 = t7.containerWidth, r5 = t7.containerHeight, l6 = t7.width, a6 = t7.height, c10 = i5, d4 = n5;
  switch (e8) {
    case "top":
      c10 += (o5 - l6) / 2;
      break;
    case "top-right":
      ...
      break;
    case "right":
      c10 += o5 - l6, d4 += (r5 - a6) / 2;
      break;
    case "bottom-right":
      c10 += o5 - l6, d4 += r5 - a6;
      break;
    case "bottom":
      c10 += (o5 - l6) / 2, d4 += r5 - a6;
      break;
    case "bottom-left":
      d4 += r5 - a6;
      break;
    case "left":
      ...
      break;
    case "center":
      c10 += (o5 - l6) / 2, d4 += (r5 - a6) / 2;
  }
  return { x: c10, y: d4 };
};
var C4 = function(t7) {
  var e8, i5, n5, o5, r5, l6, a6 = t7.direction, c10 = t7.justify, d4 = t7.symbolSize, s5 = t7.symbolSpacing, h2 = t7.width, g3 = t7.height;
  switch (a6) {
    case "left-to-right":
      e8 = 0, i5 = (g3 - d4) / 2, o5 = g3 / 2, l6 = "central", c10 ? (n5 = h2, r5 = "end") : (n5 = d4 + s5, r5 = "start");
      break;
    case "right-to-left":
      e8 = h2 - d4, i5 = (g3 - d4) / 2, o5 = g3 / 2, l6 = "central", c10 ? (n5 = 0, r5 = "start") : (n5 = h2 - d4 - s5, r5 = "end");
      break;
    case "top-to-bottom":
      e8 = (h2 - d4) / 2, i5 = 0, n5 = h2 / 2, r5 = "middle", c10 ? (o5 = g3, l6 = "alphabetic") : (o5 = d4 + s5, l6 = "text-before-edge");
      break;
    case "bottom-to-top":
      e8 = (h2 - d4) / 2, i5 = g3 - d4, n5 = h2 / 2, r5 = "middle", c10 ? (o5 = 0, l6 = "text-before-edge") : (o5 = g3 - d4 - s5, l6 = "alphabetic");
  }
  return { symbolX: e8, symbolY: i5, labelX: n5, labelY: o5, labelAnchor: r5, labelAlignment: l6 };
};
var Y = { circle: v2, diamond: u4, square: p3, triangle: y4 };
var O3 = function(i5) {
  var n5, o5, r5, a6, s5, m3, f4, v3, u5, p4, y5, b2 = i5.x, x5 = i5.y, S2 = i5.width, A4 = i5.height, W2 = i5.data, z2 = i5.direction, w2 = void 0 === z2 ? "left-to-right" : z2, X = i5.justify, O4 = void 0 !== X && X, B3 = i5.textColor, H2 = i5.background, E4 = void 0 === H2 ? "transparent" : H2, j3 = i5.opacity, L = void 0 === j3 ? 1 : j3, M3 = i5.symbolShape, P2 = void 0 === M3 ? "square" : M3, F2 = i5.symbolSize, T2 = void 0 === F2 ? 16 : F2, V2 = i5.symbolSpacing, R = void 0 === V2 ? 8 : V2, D2 = i5.symbolBorderWidth, q = void 0 === D2 ? 0 : D2, G = i5.symbolBorderColor, I = void 0 === G ? "transparent" : G, N2 = i5.onClick, _ = i5.onMouseEnter, J = i5.onMouseLeave, K2 = i5.toggleSerie, Q = i5.effects, U = (0, import_react19.useState)({}), Z = U[0], $ = U[1], tt = k(), et2 = (0, import_react19.useCallback)(function(t7) {
    if (Q) {
      var e8 = Q.filter(function(t8) {
        return "hover" === t8.on;
      }).reduce(function(t8, e9) {
        return k4({}, t8, e9.style);
      }, {});
      $(e8);
    }
    null == _ || _(W2, t7);
  }, [_, W2, Q]), it2 = (0, import_react19.useCallback)(function(t7) {
    if (Q) {
      var e8 = Q.filter(function(t8) {
        return "hover" !== t8.on;
      }).reduce(function(t8, e9) {
    ...
    null == J || J(W2, t7);
  }, [J, W2, Q]), nt = C4({ direction: w2, justify: O4, symbolSize: null != (n5 = Z.symbolSize) ? n5 : T2, symbolSpacing: R, width: S2, height: A4 }), ot2 = nt.symbolX, rt = nt.symbolY, lt2 = nt.labelX, at = nt.labelY, ct = nt.labelAnchor, dt2 = nt.labelAlignment, st2 = [N2, _, J, K2].some(function(t7) {
    return void 0 !== t7;
  }), ht = "function" == typeof P2 ? P2 : Y[P2];
  return (0, import_jsx_runtime5.jsxs)("g", { transform: "translate(" + b2 + "," + x5 + ")", style: { opacity: null != (o5 = Z.itemOpacity) ? o5 : L }, children: [(0, import_jsx_runtime5.jsx)("rect", { width: S2, height: A4, fill: null != (r5 = Z.itemBackground) ? r5 : E4, style: { cursor: st2 ? "pointer" : "auto" }, onClick: function(t7) {
    null == N2 || N2(W2, t7), null == K2 || K2(W2.id);
  }, onMouseEnter: et2, onMouseLeave: it2 }), l5.createElement(ht, k4({ id: W2.id, x: ot2, y: rt, size: null != (a6 = Z.symbolSize) ? a6 : T2, fill: null != (s5 = null != (m3 = W2.fill) ? m3 : W2.color) ? s5 : "black", borderWidth: null != (f4 = Z.symbolBorderWidth) ? f4 : q, borderColor: null != (v3 = Z.symbolBorderColor) ? v3 : I }, W2.hidden ? tt.legends.hidden.symbol : void 0)), (0, import_jsx_runtime5.jsx)(c8, { textAnchor: ct, style: k4({}, tt.legends.text, { fill: null != (u5 = null != (p4 = null != (y5 = Z.itemTextColor) ? y5 : B3) ? p4 : tt.legends.text.fill) ? u5 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, W2.hidden ? tt.legends.hidden.text : void 0), x: lt2, y: at, children: W2.label })] });
};
var B2 = function(e8) {
  var i5 = e8.data, n5 = e8.x, o5 = e8.y, r5 = e8.direction, l6 = e8.padding, a6 = void 0 === l6 ? 0 : l6, c10 = e8.justify, d4 = e8.effects, s5 = e8.itemWidth, h2 = e8.itemHeight, g3 = e8.itemDirection, m3 = void 0 === g3 ? "left-to-right" : g3, f4 = e8.itemsSpacing, v3 = void 0 === f4 ? 0 : f4, u5 = e8.itemTextColor, p4 = e8.itemBackground, y5 = void 0 === p4 ? "transparent" : p4, k5 = e8.itemOpacity, b2 = void 0 === k5 ? 1 : k5, x5 = e8.symbolShape, A4 = e8.symbolSize, C5 = e8.symbolSpacing, W2 = e8.symbolBorderWidth, z2 = e8.symbolBorderColor, w2 = e8.onClick, X = e8.onMouseEnter, Y2 = e8.onMouseLeave, B3 = e8.toggleSerie, H2 = S({ itemCount: i5.length, itemWidth: s5, itemHeight: h2, itemsSpacing: v3, direction: r5, padding: a6 }).padding, E4 = "row" === r5 ? s5 + v3 : 0, j3 = "column" === r5 ? h2 + v3 : 0;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + n5 + "," + o5 + ")", children: i5.map(function(e9, i6) {
    return (0, import_jsx_runtime5.jsx)(O3, { data: e9, x: i6 * E4 + H2.left, y: i6 * j3 + H2.top, width: s5, height: h2, direction: m3, justify: c10, effects: d4, textColor: u5, background: y5, opacity: b2, symbolShape: x5, symbolSize: A4, symbolSpacing: C5, symbolBorderWidth: W2, symbolBorderColor: z2, onClick: w2, onMouseEnter: X, onMouseLeave: Y2, toggleSerie: B3 }, i6);
  }) });
};
var H = function(e8) {
  var i5 = e8.data, n5 = e8.containerWidth, o5 = e8.containerHeight, r5 = e8.translateX, l6 = void 0 === r5 ? 0 : r5, a6 = e8.translateY, c10 = void 0 === a6 ? 0 : a6, d4 = e8.anchor, s5 = e8.direction, h2 = e8.padding, g3 = void 0 === h2 ? 0 : h2, m3 = e8.justify, f4 = e8.itemsSpacing, v3 = void 0 === f4 ? 0 : f4, u5 = e8.itemWidth, p4 = e8.itemHeight, y5 = e8.itemDirection, k5 = e8.itemTextColor, b2 = e8.itemBackground, x5 = e8.itemOpacity, C5 = e8.symbolShape, W2 = e8.symbolSize, z2 = e8.symbolSpacing, w2 = e8.symbolBorderWidth, X = e8.symbolBorderColor, Y2 = e8.onClick, O4 = e8.onMouseEnter, H2 = e8.onMouseLeave, E4 = e8.toggleSerie, j3 = e8.effects, L = S({ itemCount: i5.length, itemsSpacing: v3, itemWidth: u5, itemHeight: p4, direction: s5, padding: g3 }), M3 = L.width, P2 = L.height, F2 = A3({ anchor: d4, translateX: l6, translateY: c10, containerWidth: n5, containerHeight: o5, width: M3, height: P2 }), T2 = F2.x, V2 = F2.y;
  return (0, import_jsx_runtime5.jsx)(B2, { data: i5, x: T2, y: V2, direction: s5, padding: g3, justify: m3, effects: j3, itemsSpacing: v3, itemWidth: u5, itemHeight: p4, itemDirection: y5, itemTextColor: k5, itemBackground: b2, itemOpacity: x5, symbolShape: C5, symbolSize: W2, symbolSpacing: z2, symbolBorderWidth: w2, symbolBorderColor: X, onClick: Y2, onMouseEnter: O4, onMouseLeave: H2, toggleSerie: "boolean" == typeof E4 ? void 0 : E4 });
};
var E3 = { start: "left", middle: "center", end: "right" };
var j2 = function(t7, e8) {
  var i5 = e8.data, n5 = e8.containerWidth, o5 = e8.containerHeight, r5 = e8.translateX, l6 = void 0 === r5 ? 0 : r5, a6 = e8.translateY, c10 = void 0 === a6 ? 0 : a6, d4 = e8.anchor, s5 = e8.direction, h2 = e8.padding, g3 = void 0 === h2 ? 0 : h2, v3 = e8.justify, u5 = void 0 !== v3 && v3, p4 = e8.itemsSpacing, y5 = void 0 === p4 ? 0 : p4, b2 = e8.itemWidth, x5 = e8.itemHeight, W2 = e8.itemDirection, z2 = void 0 === W2 ? "left-to-right" : W2, w2 = e8.itemTextColor, X = e8.symbolSize, Y2 = void 0 === X ? 16 : X, O4 = e8.symbolSpacing, B3 = void 0 === O4 ? 8 : O4, H2 = e8.theme, j3 = S({ itemCount: i5.length, itemWidth: b2, itemHeight: x5, itemsSpacing: y5, direction: s5, padding: g3 }), L = j3.width, M3 = j3.height, P2 = j3.padding, F2 = A3({ anchor: d4, translateX: l6, translateY: c10, containerWidth: n5, containerHeight: o5, width: L, height: M3 }), T2 = F2.x, V2 = F2.y, R = "row" === s5 ? b2 + y5 : 0, D2 = "column" === s5 ? x5 + y5 : 0;
  t7.save(), t7.translate(T2, V2), r4(t7, H2.legends.text), i5.forEach(function(e9, i6) {
    var n6, o6 = i6 * R + P2.left, r6 = i6 * D2 + P2.top, l7 = C4({ direction: z2, justify: u5, symbolSize: Y2, symbolSpacing: B3, width: b2, height: x5 }), a7 = l7.symbolX, c11 = l7.symbolY, d5 = l7.labelX, s6 = l7.labelY, h3 = l7.labelAnchor, g4 = l7.labelAlignment;
    t7.fillStyle = null != (n6 = e9.color) ? n6 : "black", t7.fillRect(o6 + a7, r6 + c11, Y2, Y2), t7.textAlign = E3[h3], "central" === g4 && (t7.textBaseline = "middle"), o4(t7, k4({}, H2.legends.text, { fill: null != w2 ? w2 : H2.legends.text.fill }), String(e9.label), o6 + d5, r6 + s6);
  }), t7.restore();
};
...
//# sourceMappingURL=chunk-EFKILSXK.js.map
