  ...
  useEffect(() => {
    if (client) {
      setEditableClient({
        ...
        region_state: client.region_state || "",
        status: client.status as "active" | "inactive" | "delinquent",
        plan_name: client.plan_name || "",
        monthly_fee: client.monthly_fee !== undefined ? client.monthly_fee : null,
        ad_budget: client.ad_budget !== undefined ? client.ad_budget : null,
        notes: client.notes || '',
      });
